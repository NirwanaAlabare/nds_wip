        ...
        if ($request->ajax()) {
            ...
            if ($start_date === null || $end_date === null) {
                ...
                if ($start_date < $today && $end_date < $today) {
                    ...
                    FROM mgt_rep_tmp_sum_prod_full_earning WHERE tanggal >= '$start_date' and tanggal <= '$end_date'");
                } else {
...
select * from sum_full_earning where tanggal >= '$start_date' and tanggal <= '$end_date'
order by tanggal asc
        ");
                }
