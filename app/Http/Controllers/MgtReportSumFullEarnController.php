...
class MgtReportSumFullEarnController extends Controller
{
    public function mgt_report_sum_full_earn(Request $request)
    {
        $user = Auth::user()->name;
...
order by a.tanggal asc
        ...
        return view('management_report.laporan_sum_full_earn', [
            'page' => 'dashboard-mgt-report',
            'subPageGroup' => 'mgt-report-laporan',
            'subPage' => 'mgt-report-laporan-sum-full-earn',
            'containerFluid' => true,
            'user' => $user,
        ]);
    }
    ...
    public function export_excel_laporan_sum_full_earn(Request $request)
    {
        return Excel::download(new export_excel_laporan_sum_full_earn($request->start_date, $request->end_date), 'Laporan_Penerimaan FG_Stok.xlsx');
    }
}
