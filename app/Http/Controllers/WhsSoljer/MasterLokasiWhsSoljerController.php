...
class MasterLokasiWhsSoljerController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view("whs-soljer.master-lokasi.index", [
            'arealok' => $arealok,
            'unit' => $unit,
    ...
    //     return view('master.create-lokasi', ['arealok' => $arealok,'unit' => $unit, 'page' => 'dashboard-whs-soljer']);
    // }
    ...
    public function updatestatus(Request $request)
    {
        ...
        $massage = 'Change Status Successfully';
            ...
            return array(
                ...
                "message" => $massage,
                "additional" => [],
                "redirect" => url('/master-lokasi-whs-soljer')
            );
    ...
    public function printlokasi(Request $request, $id)
    {
        ...
        $pdf = PDF::loadView('whs-soljer.master-lokasi.print-lokasi', ["dataLokasi" => $dataLokasi])->setPaper('a7', 'landscape');
...
// ->get();
    ...
    //     return view('master.update-lokasi', ["dataLokasi" => $dataLokasi,'arealok' => $arealok,'unit' => $unit, 'page' => 'dashboard-whs-soljer']);
    // }
