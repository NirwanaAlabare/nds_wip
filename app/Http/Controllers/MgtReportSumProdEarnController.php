...
earn as (
 SELECT
                ...
                (
                    ...
                    where a.updated_at >= '$start_date 00:00:00' and a.updated_at <= '$end_date 23:59:59'
                ...
                left join (
                    ...
                    left join userpassword on userpassword.line_id = user_sb_wip.line_id
                    where output_rfts.updated_at >= '$start_date 00:00:00' and output_rfts.updated_at <= '$end_date 23:59:59' group by userpassword.username, date(output_rfts.updated_at)
                ...
                left join (
                    ...
                    (
                            ...
                            left join user_sb_wip on user_sb_wip.id = a.created_by
                            left join userpassword on userpassword.line_id = user_sb_wip.line_id
                            where a.updated_at >= '$start_date 00:00:00' and a.updated_at <= '$end_date 23:59:59' and status = 'NORMAL'
                            group by master_plan_id, userpassword.username, date(a.updated_at)
                    ) a
                    inner join master_plan mp on a.master_plan_id = mp.id
