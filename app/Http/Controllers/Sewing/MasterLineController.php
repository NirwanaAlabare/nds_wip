    ...
    public function store(Request $request) {
        ...
        // if ($validatedRequest["chief_id"] || $validatedRequest["leader_id"]) {
            $storeEmployeeLine = EmployeeLine::create([
                ...
                "chief_id" => $validatedRequest["chief_id"] && $validatedRequest["chief_id"] != 'null' ? $validatedRequest["chief_id"] : null,
                "chief_nik" => $validatedRequest["chief_nik"] && $validatedRequest["chief_nik"] != 'null' ? $validatedRequest["chief_nik"] : null,
                "chief_name" => $validatedRequest["chief_name"] && $validatedRequest["chief_name"] != 'null' ? $validatedRequest["chief_name"] : null,
                "leader_id" => $validatedRequest["leader_id"] && $validatedRequest["leader_id"] != 'null' ? $validatedRequest["leader_id"] : null,
                "leader_nik" => $validatedRequest["leader_nik"] && $validatedRequest["leader_nik"] != 'null' ? $validatedRequest["leader_nik"] : null,
                "leader_name" => $validatedRequest["leader_name"] && $validatedRequest["leader_name"] != 'null' ? $validatedRequest["leader_name"] : null,
                "ie_id" => $validatedRequest["ie_id"] && $validatedRequest["ie_id"] != 'null' ? $validatedRequest["ie_id"] : null,
                "ie_nik" => $validatedRequest["ie_nik"] && $validatedRequest["ie_nik"] != 'null' ? $validatedRequest["ie_nik"] : null,
                "ie_name" => $validatedRequest["ie_name"] && $validatedRequest["ie_name"] != 'null' ? $validatedRequest["ie_name"] : null,
                "leaderqc_id" => $validatedRequest["leaderqc_id"] && $validatedRequest["leaderqc_id"] != 'null' ? $validatedRequest["leaderqc_id"] : null,
                "leaderqc_nik" => $validatedRequest["leaderqc_nik"] && $validatedRequest["leaderqc_nik"] != 'null' ? $validatedRequest["leaderqc_nik"] : null,
                "leaderqc_name" => $validatedRequest["leaderqc_name"] && $validatedRequest["leaderqc_name"] != 'null' ? $validatedRequest["leaderqc_name"] : null,
                "mechanic_id" => $validatedRequest["mechanic_id"] && $validatedRequest["mechanic_id"] != 'null' ? $validatedRequest["mechanic_id"] : null,
                "mechanic_nik" => $validatedRequest["mechanic_nik"] && $validatedRequest["mechanic_nik"] != 'null' ? $validatedRequest["mechanic_nik"] : null,
                "mechanic_name" => $validatedRequest["mechanic_name"] && $validatedRequest["mechanic_name"] != 'null' ? $validatedRequest["mechanic_name"] : null,
                "technical_id" => $validatedRequest["technical_id"] && $validatedRequest["technical_id"] != 'null' ? $validatedRequest["technical_id"] : null,
                "technical_nik" => $validatedRequest["technical_nik"] && $validatedRequest["technical_nik"] != 'null' ? $validatedRequest["technical_nik"] : null,
                "technical_name" => $validatedRequest["technical_name"] && $validatedRequest["technical_name"] != 'null' ? $validatedRequest["technical_name"] : null,
    ...
    public function update(Request $request) {
        ...
        if ($validatedRequest["edit_chief_id"] || $validatedRequest["edit_leader_id"]) {
            $updateEmployeeLine = EmployeeLine::where("id", $validatedRequest["edit_id"])->update([
                ...
                "chief_id" => $validatedRequest["edit_chief_id"] && $validatedRequest["edit_chief_id"] != 'null' ? $validatedRequest["edit_chief_id"] : null,
                "chief_nik" => $validatedRequest["edit_chief_nik"] && $validatedRequest["edit_chief_nik"] != 'null' ? $validatedRequest["edit_chief_nik"] : null,
                "chief_name" => $validatedRequest["edit_chief_name"] && $validatedRequest["edit_chief_name"] != 'null' ? $validatedRequest["edit_chief_name"] : null,
                "leader_id" => $validatedRequest["edit_leader_id"] && $validatedRequest["edit_leader_id"] != 'null' ? $validatedRequest["edit_leader_id"] : null,
                "leader_nik" => $validatedRequest["edit_leader_nik"] && $validatedRequest["edit_leader_nik"] != 'null' ? $validatedRequest["edit_leader_nik"] : null,
                "leader_name" => $validatedRequest["edit_leader_name"] && $validatedRequest["edit_leader_name"] != 'null' ? $validatedRequest["edit_leader_name"] : null,
                "ie_id" => $validatedRequest["edit_ie_id"] && $validatedRequest["edit_ie_id"] != 'null' ? $validatedRequest["edit_ie_id"] : null,
                "ie_nik" => $validatedRequest["edit_ie_nik"] && $validatedRequest["edit_ie_nik"] != 'null' ? $validatedRequest["edit_ie_nik"] : null,
                "ie_name" => $validatedRequest["edit_ie_name"] && $validatedRequest["edit_ie_name"] != 'null' ? $validatedRequest["edit_ie_name"] : null,
                "leaderqc_id" => $validatedRequest["edit_leaderqc_id"] && $validatedRequest["edit_leaderqc_id"] != 'null' ? $validatedRequest["edit_leaderqc_id"] : null,
                "leaderqc_nik" => $validatedRequest["edit_leaderqc_nik"] && $validatedRequest["edit_leaderqc_nik"] != 'null' ? $validatedRequest["edit_leaderqc_nik"] : null,
                "leaderqc_name" => $validatedRequest["edit_leaderqc_name"] && $validatedRequest["edit_leaderqc_name"] != 'null' ? $validatedRequest["edit_leaderqc_name"] : null,
                "mechanic_id" => $validatedRequest["edit_mechanic_id"] && $validatedRequest["edit_mechanic_id"] != 'null' ? $validatedRequest["edit_mechanic_id"] : null,
                "mechanic_nik" => $validatedRequest["edit_mechanic_nik"] && $validatedRequest["edit_mechanic_nik"] != 'null' ? $validatedRequest["edit_mechanic_nik"] : null,
                "mechanic_name" => $validatedRequest["edit_mechanic_name"] && $validatedRequest["edit_mechanic_name"] != 'null' ? $validatedRequest["edit_mechanic_name"] : null,
                "technical_id" => $validatedRequest["edit_technical_id"] && $validatedRequest["edit_technical_id"] != 'null' ? $validatedRequest["edit_technical_id"] : null,
                "technical_nik" => $validatedRequest["edit_technical_nik"] && $validatedRequest["edit_technical_nik"] != 'null' ? $validatedRequest["edit_technical_nik"] : null,
                "technical_name" => $validatedRequest["edit_technical_name"] && $validatedRequest["edit_technical_name"] != 'null' ? $validatedRequest["edit_technical_name"] : null,
            ]);
