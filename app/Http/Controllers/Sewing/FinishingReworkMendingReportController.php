...
class FinishingReworkMendingReportController extends Controller
{
    ...
    {
        $data = $this->getReworkMendingData($request->start_date, $request->end_date, $request->buyer);
    ...
    public function exportExcel(Request $request)
    {
        ...
        $fileName = 'Report_Rework_Mending_Finishing_' . date('Ymd_His') . '.xlsx';
        ...
        return Excel::download(new class($data, $start, $end) implements FromCollection, WithHeadings, WithStyles {
            ...
            public function headings(): array {
                ...
                return [
                    ...
                    ["REPORT REWORK MENDING (QC FINISHING)"],
                    [$periode],
                    [""],
