...
class SewingMendingReportController extends Controller
{
    public function index()
    {
        ...
        return view('sewing.report.report-mending-sewing', [
            'page'           => 'dashboard-sewing-eff',
            'subPageGroup'   => 'sewing-report',
            'subPage'        => 'reportMending',
            'containerFluid' => true,
    ...
    public function exportExcel(Request $request)
    {
        ...
        $data = collect($this->getMendingData($start_date, $end_date, $request->buyer));

        $fileName = 'Report_Defect_Mending_' . date('Ymd_His') . '.xlsx';
