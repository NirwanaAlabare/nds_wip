...
class MasterPlanController extends Controller
{
    ...
    public function importMasterPlanPreview(Request $request)
    {
        ...
        foreach ($dataRows as $row)
        {
            ...
            $excelDate = $row[0];
            $convertedDate = Date::excelToDateTimeObject(intval($excelDate));
            ...
            $data[] = [
                ...
                "tgl_input" => Carbon::now(),
                "id_ws" => $orderInfo && $orderInfo[0] ? $orderInfo[0]->id_cost : null,
                "ws" => $orderInfo && $orderInfo[0] ? $orderInfo[0]->ws : $row[2],
                "color" => $orderInfo && $orderInfo[0] ? $orderInfo[0]->color : $row[3],
                "smv" => $row[4],
                "jam_kerja" => $row[5],
                "man_power" => $row[6],
                "plan_target" => $row[7],
