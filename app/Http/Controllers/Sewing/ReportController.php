...
use App\Exports\Sewing\OutputExport;
use App\Exports\Sewing\OutputExportCustomRange;
use App\Exports\ProductionExport;
use App\Exports\ProductionAllExport;
use App\Exports\ProductionDefectExport;
use App\Exports\Sewing\OrderOutputExport;
...
class ReportController extends Controller
{
    ...
    public function exportOutput(Request $request) {
        ...
        return Excel::download(new OutputExport($date, $subtype, $search, $group), 'output_export.xlsx');
    }
