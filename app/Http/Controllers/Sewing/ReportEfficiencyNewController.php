...
class ReportEfficiencyNewController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $selisih_hari = Carbon::parse($tgl_akhir_n)->diffInDays(now());
            ...
            if ($selisih_hari < 30) {
                ...
                $realStart = $start_date >= $realtimeStartDate . ' 00:00:00'
                    ? $start_date
                    : $realtimeStartDate . ' 00:00:00';
                ...
                $sql = "
                    SELECT
                        ...
                        rfts
                    FROM mgt_rep_tmp_earn
                    WHERE tgl_trans >= '$tgl_awal_n'
                    AND tgl_trans <= '$tgl_akhir_n'
                    ORDER BY tgl_trans ASC, sewing_line ASC, kpno ASC
                ";
            }
