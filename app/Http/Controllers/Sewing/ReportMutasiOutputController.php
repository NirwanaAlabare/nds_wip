        ...
        $query = "WITH
            ...
            saldo_sew as(
                ...
                (
                    ...
                    CASE WHEN output_secondary_master.secondary = 'Pasang Kancing' THEN rft + rework ELSE 0 END AS rft_sp_pasang_kancing,
                    ...
                    CASE WHEN output_secondary_master.secondary = 'Bartack' THEN rft + rework ELSE 0 END AS rft_sp_bartack,
                    ...
                    CASE WHEN output_secondary_master.secondary = 'Heatseal' THEN rft + rework ELSE 0 END AS rft_sp_heatseal,
                    ...
                    CASE WHEN output_secondary_master.secondary = 'Snap' THEN rft + rework ELSE 0 END AS rft_sp_snap,
                    ...
                    CASE WHEN output_secondary_master.secondary = 'Embro' THEN rft + rework ELSE 0 END AS rft_sp_embro,
