...
class ReportMutasiOutputController extends Controller
{
    ...
    public function export_excel_mut_output(Request $request)
    {
                ...
                FROM (
                    WITH
                        ...
                        SELECT
                            ...
                            SUM(COALESCE(saldo_akhir_sewing, 0)) as saldo_akhir_sewing,
                            ...
                            SUM(COALESCE(saldo_akhir_finishing, 0)) as saldo_akhir_finishing,
                            ...
                            SUM(COALESCE(saldo_akhir_secondary_proses, 0)) as saldo_akhir_secondary_proses,
                            ...
                            SUM(COALESCE(saldo_akhir_defect_sewing, 0)) as saldo_akhir_defect_sewing,
                            ...
                            SUM(COALESCE(saldo_akhir_defect_spotcleaning, 0)) as saldo_akhir_defect_spotcleaning,
                            ...
                            SUM(COALESCE(saldo_akhir_mending, 0)) as saldo_akhir_mending,
                            ...
                            SUM(COALESCE(saldo_akhir_qc_reject, 0)) as saldo_akhir_qc_reject
                        FROM
        ...
        $sheet->writeTo('R3', 'Terima Loading')->applyFontStyleBold()->applyBorder(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
