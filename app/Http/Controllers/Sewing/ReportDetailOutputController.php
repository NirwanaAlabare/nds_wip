...
use App\Exports\ExportReportDetailOutputData;
use App\Exports\ExportReportDetailOutputDataPacking;
...
class ReportDetailOutputController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sewing.report.report-detail-output', ['parentPage' => 'report', 'page' => 'report-detail-output', 'months' => $months, 'years' => $years]);
    }
