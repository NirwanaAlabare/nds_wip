...
class StockerRejectController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $dataStockerReject = DB::select("
                ...
                (
                    ...
                    GROUP BY
                        dc_in_input.id UNION ALL-- secondary_inhouse_input
                    SELECT
                        tgl_trans tanggal,
                    ...
                    GROUP BY
                        secondary_inhouse_input.id UNION ALL-- secondary_in_input
                    SELECT
                        tgl_trans tanggal,
        ...
        return view('stocker.stocker.stocker-reject.stocker-reject', ['page' => 'dashboard-stocker', 'subPageGroup' => 'stocker-reject', 'subPage' => 'stocker-reject']);
    }
