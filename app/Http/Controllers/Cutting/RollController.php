            ...
            if ($item->tipe_form_cut !== 'PIPING' && $item->tipe_form_cut !== 'PCS') {
                ...
                if ($item->status !== 'extension complete') {
                    ...
                    $row = array_merge($row, [
                        ...
                        $item->unit_roll,
                        ($item->berat_amparan ?? 0),
                        ($item->est_amparan ?? 0),
                        ($item->lembar_gelaran ?? 0),
                        ($item->total_ratio ?? 0),
                        ($item->qty_cut ?? 0),
                        $item->average_time,
                        ($item->sisa_gelaran ?? 0),
                        $latestStatus !== 'extension complete' ? 0 : ($latestSambungan ?? 0),
                        ($currentSambunganRoll ?? 0),
                        ($currentKepalaKain ?? 0),
                        ($currentSisaTidakBisa ?? 0),
                        ($currentReject ?? 0),
                        (($latestStatus !== 'extension complete'
                            ? $item->piping
                            : round($item->piping + $latestPiping, 2)) ?? 0),
                        ($item->sisa_kain ?? 0),
                        ($currentPemakaianLembar ?? 0),
                        ($currentTotalPemakaian ?? 0),
                        ($currentShortRoll ?? 0),
                        ($currentShortRollPercentage ?? 0) . ' %',
                    ]);
                } else {
                ...
                $row = array_merge($row, [
                    ...
                    ($item->sisa_gelaran ?? 0),
                    ($item->sambungan ?? 0),
                    ($item->sambungan_roll ?? 0),
                    ($item->kepala_kain ?? 0),
                    ($item->sisa_tidak_bisa ?? 0),
                    ($item->reject ?? 0),
                    ($item->piping ?? 0),
                    ($item->sisa_kain ?? 0),
                    ($item->pemakaian_lembar ?? 0),
                    ($item->total_pemakaian_roll ?? 0),
                    ($item->short_roll ?? 0),
                    ($item->short_roll_percentage ?? 0) . ' %',
                ]);
            }
