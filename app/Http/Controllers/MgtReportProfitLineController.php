...
class MgtReportProfitLineController extends Controller
{
    public function mgt_report_profit_line(Request $request)
    {
...
order by sewing_line asc, tanggal asc
        ...
        return view('management_report.laporan_profit_line', [
            'page' => 'dashboard-mgt-report',
            'subPageGroup' => 'mgt-report-laporan',
            'subPage' => 'mgt-report-laporan-profit-line',
            'pivotData' => $pivot,
    ...
    public function export_excel_laporan_profit_line(Request $request)
    {
        return Excel::download(new export_excel_laporan_profit_line($request->start_date, $request->end_date), 'Laporan_Penerimaan FG_Stok.xlsx');
    }
}
