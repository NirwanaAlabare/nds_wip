...
class ManageUserLineController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $users = UserLine::selectRaw("line_id as id, FullName as name, username, Password as password, Groupp as type, Locked as locked")->whereIn("Groupp", ["SEWING", "ALLSEWING", "MENDING", "SPOTCLEANING", "QCREJECT", "SECONDARYSEWINGIN", "SECONDARYSEWINGOUT", "SECONDARYSEWINGINOUT"])->orderBy("line_id", "desc");
