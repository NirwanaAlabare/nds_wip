...
class QCInmaterialFabricController extends Controller
{
    ...
    // Di bagian Controller (QCInmaterialFabricController.php), modifikasi query getDatatables:
    ...
    public function getDatatables(Request $request)
    {
       ...
       $data = DB::connection('mysql_sb')->select("
            SELECT 
                ...
                d.color,
                d.id_item,
                c.id as id_whs_lokasi_inmaterial,
                c.no_lot,
                ...
                a.no_dok,
                EXISTS (
                    SELECT 1 FROM qc_inspect_list_inspect q 
                    WHERE CONVERT(q.no_pl USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(a.no_invoice USING utf8mb4) COLLATE utf8mb4_unicode_ci
                    AND CONVERT(q.no_lot USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(c.no_lot USING utf8mb4) COLLATE utf8mb4_unicode_ci
                    AND CONVERT(q.color USING utf8mb4) COLLATE utf8mb4_unicode_ci = CONVERT(d.color USING utf8mb4) COLLATE utf8mb4_unicode_ci
