...
class Export_excel_rep_packing_mutasi implements FromView, WithEvents, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        //                         CASE
        //                             WHEN type = 'packing_line'
        //                             THEN saldo ELSE 0
        //                         END AS pl_saldo_awal,

        //                         0 AS pl_rft,
        //                         0 AS pl_reject,

        //                         CASE
        //                             WHEN type = 'transfer_garment'
        //                             THEN saldo ELSE 0
        //                         END AS tg_saldo_awal,

        //                         0 AS tg_masuk,
        //                         0 AS tg_keluar,

        //                         CASE
        //                             WHEN type = 'packing_center'
        //                             THEN saldo ELSE 0
        //                         END AS pc_saldo_awal,
        ...
        //                         JOIN ppic_master_so pms
        //                             ON pms.id = tg.id_ppic_master_so
        ...
        //                             0,
        //                             SUM(qty)
        //                         FROM laravel_nds.packing_packing_in pi
        //                         JOIN ppic_master_so pms
        //                             ON pms.id = pi.id_ppic_master_so
        //                         WHERE pms.id_so_det IS NOT NULL
        ...
        //                             0,
        //                             COUNT(*) AS keluar
        //                         FROM laravel_nds.packing_packing_out_scan pos
        //                         JOIN ppic_master_so pms
        //                             ON pms.id = pos.id_ppic
        //                         WHERE pms.id_so_det IS NOT NULL
        //                         AND pos.tgl_trans >= '{$tanggal_saldo_awal} 00:00:00'
        //                         AND pos.tgl_trans < '{$tgl_awal} 00:00:00'
        //                         GROUP BY pms.id_so_det
        ...
        //                             ON pms.id = pos.id_ppic
        //                         WHERE pms.id_so_det IS NOT NULL
        //                         AND pos.tgl_trans BETWEEN '{$tgl_awal} 00:00:00'
        //                                             AND '{$tgl_akhir} 23:59:59'
        //                         GROUP BY pms.id_so_det
        ...
        //                     JOIN master_sb_ws msw
        //                         ON msw.id_so_det = t.so_det_id

        //                     JOIN master_size_new msn
        //                         ON msn.size = msw.size
