...
class export_excel_laporan_sum_full_earn implements FromView, ShouldAutoSize, WithEvents
{
    use Exportable;
...
order by tanggal asc
        ...
        return view('management_report.export_excel_laporan_sum_full_earn', [
            'rawData' => $rawData,
        ]);
    }
