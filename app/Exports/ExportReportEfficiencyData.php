<?php
    ...
    class ExportReportEfficiencyData implements FromView, ShouldAutoSize, ShouldQueue, withTitle, WithColumnFormatting, WithEvents
    {
        use Exportable;
        ...
        public function view(): View
        {
            $dataDetailProduksiDay =  DataDetailProduksiDay::selectRaw("
                ...
                ->where('data_detail_produksi_day.tgl_produksi', "=", $this->tanggal)
                ->where('summary_line.tgl_produksi_line', "=", $this->tanggal)
        ...
        public static function afterSheet(AfterSheet $event){
            ...
            $event->sheet->styleCells(
                'A6:R'.$event->getConcernable()->rowCount,
                [
                    'borders' => [
                        'allBorders' => [
                            'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
