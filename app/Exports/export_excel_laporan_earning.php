    ...
    public function view(): View
    {
        ...
        if ($this->start_date < $today && $this->end_date < $today) {
            $rawData = DB::connection('mysql_sb')->select("SELECT
                    ...
                    blc_earn_mkt,
                    percent_earn_mkt
                    FROM mgt_rep_tmp_earning WHERE tanggal >= '$this->start_date' and tanggal <= '$this->end_date'");
        } else {
...
SELECT
    ...
    select * from earning where tanggal >= '$this->start_date' and tanggal <= '$this->end_date'
