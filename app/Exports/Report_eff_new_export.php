...
class Report_eff_new_export implements FromView, WithEvents, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        $realtimeStartDate = date('Y-m-d', strtotime($this->tgl_akhir . ' -3 day'));
        $queryTemp = "";

        if ($this->tgl_awal < $realtimeStartDate) {
            ...
            $queryTemp = "
                ...
                WHERE tgl_trans >= '$this->tgl_awal'
                AND tgl_trans <= '$tempEndDate'
            ";
        }


        $realStart = $this->tgl_awal >= $realtimeStartDate
            ? $this->tgl_awal
            : $realtimeStartDate;
        ...
        $queryRealtime = "
            SELECT
                ...
                CASE
                    ...
                    THEN if(
                        acm.jenis_rate = 'J',
                        acm.price * COALESCE(konv_sb.rate_jual, last_konv_sb.rate_jual),
                        acm.price
                    )
                    ELSE acm.price
                end AS cm_price,
                ...
                round(
                    if (
                        ...
                        CASE
                            ...
                            ELSE acm.price
                        end * COALESCE(mr.kurs_tengah,mkb.kurs_tengah)
            ...
            (
                ...
                and a.updated_at <= '$this->tgl_akhir'
            ...
            left join (
                ...
                and output_rfts.updated_at <= '$this->tgl_akhir'
