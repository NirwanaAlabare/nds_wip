                                ...
                                WITH
                                                ...
                                                sii as (
                                                                ...
                                                                SELECT
                                                                                ...
                                                                                null sec_inhouse_in_main,
                                                                                null sec_inhouse_in,
                                                                                (CASE WHEN tgl_trans < '".$dateFrom."' THEN sii.qty_replace ELSE null END) sec_inhouse_rep_main,
                                                                                null sec_inhouse_rep,
                                                                ...
                                                                SELECT
                                                                                ...
                                                                                null sec_inhouse_in,
                                                                                null sec_inhouse_rep_main,
                                                                                (CASE WHEN tgl_trans < '".$dateFrom."' THEN sii.qty_replace ELSE null END) sec_inhouse_rep,
                                                                                null sec_inhouse_out_main,
                                                                ...
                                                                UNION ALL
                                                                                ...
                                                                                null sec_inhouse_in_main,
                                                                                null sec_inhouse_in,
                                                                                (CASE WHEN si.tgl_trans >= '".$dateFrom."' THEN si.qty_replace ELSE null END) sec_inhouse_rep_main,
                                                                                null sec_inhouse_rep,
                                                                                null sec_inhouse_out_main,
                                                                                null sec_inhouse_out,
                                                                                null sec_in_in_main,
                                                                ...
                                                                SELECT
                                                                                ...
                                                                                null sec_inhouse_in,
                                                                                null sec_inhouse_rep_main,
                                                                                (CASE WHEN si.tgl_trans >= '".$dateFrom."' THEN si.qty_replace ELSE null END) sec_inhouse_rep,
                                                                                null sec_inhouse_out_main,
                                                                                null sec_inhouse_out,
                                                                                null sec_in_in_main,
                                                                                null sec_in_in,
                                ...
                                WITH
                                                ...
                                                sii as (
                                                                SELECT
                                                                                ...
                                                                                null sec_inhouse_in_main,
                                                                                null sec_inhouse_in,
                                                                                (CASE WHEN sii.tgl_trans < '".$dateFrom."' THEN sii.qty_replace ELSE null END) sec_inhouse_rep_main,
                                                                                null sec_inhouse_rep,
                                                                                sii.qty_in sec_inhouse_out_main,
                                                                                null sec_inhouse_out,
                                                                                null sec_in_in_main,
                                                                ...
                                                                SELECT
                                                                                ...
                                                                                null sec_inhouse_in,
                                                                                null sec_inhouse_rep_main,
                                                                                (CASE WHEN sii.tgl_trans < '".$dateFrom."' THEN sii.qty_replace ELSE null END) sec_inhouse_rep,
                                                                                null sec_inhouse_out_main,
                                                                                sii.qty_in sec_inhouse_out,
                                                                                null sec_in_in_main,
                                                                                null sec_in_in,
