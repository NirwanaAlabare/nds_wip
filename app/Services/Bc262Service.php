...
class Bc262Service
{
    ...
    public function edit($id, Request $request)
    {
        ...
        $listJenisPungutan = [
            ...
            'BMKITE' => 'Bea Masuk KITE',
            'BMP' => 'Bea Masuk Pembalasan',
            'BMTP' => 'Bea Masuk Tindakan Pengamanan',
            'CEA' => 'Cukai Etil Alkohol',
            'CMEA' => 'Cukai Minuman Mengandung Etil Alkohol',
            'CTEM' => 'Cukai Tembakau',
            'DENDA' => 'Denda Administrasi Pabean',
            'DS' => 'Dana Sawit',
            'PNBP' => 'Penerimaan Negara Bukan Pajak',
            'PPH' => 'PPh Impor',
            'PPHEKSPOR' => 'PPh Ekspor',
            'PPN' => 'PPN Impor',
            'PPNBM' => 'PPnBM Impor',
            'PPNLOKAL' => 'PPN Dalam Negeri / Hasil Tembakau',
        ];
