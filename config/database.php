    ...
    */
    ...
    'connections' => [
        ...
        'mysql_so' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SO', '127.0.0.1'),
            'port' => env('DB_PORT_SO', '3306'),
            'database' => env('DB_DATABASE_SO', 'forge'),
            'username' => env('DB_USERNAME_SO', 'forge'),
            'password' => env('DB_PASSWORD_SO', ''),
            'unix_socket' => env('DB_SOCKET_SO', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
