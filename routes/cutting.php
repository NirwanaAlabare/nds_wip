...
Route::middleware('auth')->group(function () {
    ...
    // PIECE :
        ...
        Route::controller(ReportCuttingController::class)->prefix("report-cutting")->middleware('role:cutting')->group(function () {
            ...
            Route::get('/report_mutasi_wip_cutting_detail', 'report_mutasi_wip_cutting_detail')->name('report_mutasi_wip_cutting_detail');
            ...
            Route::get('/export_excel_report_mut_wip_cutting_detail', 'export_excel_report_mut_wip_cutting_detail')->name('export_excel_report_mut_wip_cutting_detail');
            ...
            Route::get('/export_excel_report_mutasi_wip_cutting_set', 'export_excel_report_mutasi_wip_cutting_set')->name('export_excel_report_mutasi_wip_cutting_set');
        });
        ...
        Route::controller(RollController::class)->prefix("lap_pemakaian")->middleware('role:cutting')->group(function () {
            ...
            Route::delete('/delete_alokasi_fabric_gr_panel/{id}', 'delete_alokasi_fabric_gr_panel')->name('delete_alokasi_fabric_gr_panel');
        });
