                ...
                <table id="datatable" class="table table-bordered w-100 text-nowrap">
                    <thead class="bg-sb">
                        <tr>
                            ...
                            <th scope="col" class="text-center align-middle">ID Roll</th>
                            ...
                            <th scope="col" class="text-center align-middle">Lama Penyimpanan (Hari)</th>
                            <th scope="col" class="text-center align-middle">Tgl. Pengeluaran</th>
                        </tr>
                        <tr>
