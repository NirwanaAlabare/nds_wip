                            ...
                            <tbody>
                                @foreach ($dataDetail as $detail)
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" name="so_det_id[{{ $index }}]" id="so_det_id_{{ $index }}" value="{{ $detail->so_det_id }}">
                                        <input type="hidden" name="size[{{ $index }}]" id="size_{{ $index }}" value="{{ $detail->size }}">
                                        ...
                                        <input type="hidden" name="qty_ply_group[{{ $index }}]" id="qty_ply_group_{{ $index }}" value="{{ $qty }}">
