                                ...
                                @foreach ($dataRatioAdditional as $ratio)
                                    @php
                                        ...
                                        if ($qtyAdditional > 0) :
                                            ...
                                            $rangeAwalAdditional = ($stockerThis ? $stockerThis->range_awal : ($dataSpreading->no_cut > 1 ? ($stockerBefore ? ($stockerBefore->stocker_id != null ? $stockerBefore->range_akhir + 1 + ($qtyBeforeAdditional) : "-") : 1 + ($qtyBeforeAdditional)) : 1 + ($qtyBeforeAdditional)));
                                            $rangeAkhirAdditional = ($stockerThis ? $stockerThis->range_akhir : ($dataSpreading->no_cut > 1 ? ($stockerBefore ? ($stockerBefore->stocker_id != null ? $stockerBefore->range_akhir + $qtyAdditional + ($qtyBeforeAdditional) : "-") : $qtyAdditional + ($qtyBeforeAdditional)) : $qtyAdditional + ($qtyBeforeAdditional)));
                                    @endphp
                                    <tr>
