                    ...
                    <td>
                        <div id="separate_qty_wrapper_{{ $indexSeparate }}"  class="d-flex flex-wrap gap-1"  data-qty="{{ $qty }}">
                            @if ($separatedStockerDetails)
                                ...
                                @endforeach
                            @else
                                <input type="number" class="form-control form-control-sm separate-part" name="separate_qty[{{ $indexSeparate }}][]" value="{{ $qty }}" oninput="validateAndAdjust({{ $indexSeparate }}, this)" onchange="validateAndAdjust({{ $indexSeparate }}, this)" onkeyup="validateAndAdjust({{ $indexSeparate }}, this)" min="0">
                            @endif
                        </div>
                        <div class="mt-1">
