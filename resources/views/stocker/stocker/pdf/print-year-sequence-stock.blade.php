    ...
    <div style="border: 1px solid;padding: 1px;">
        ...
        <table style="margin-bottom: 5px;">
            ...
            <tr>
                ...
                <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;width: auto;'>:</td>
                <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;'>{{ $stockerData->formCut && $stockerData->formCut->marker ? strtoupper(substr($stockerData->formCut->marker->style, 0, 9)).(strlen($stockerData->formCut->marker->style) > 9 ? '...' : '') : ($stockerData->formReject ? strtoupper(substr($stockerData->formReject->style, 0, 9)).(strlen($stockerData->formReject->style) > 9 ? '...' : '') : ($stockerData->formPiece ? strtoupper(substr($stockerData->formPiece->style, 0, 50)).(strlen($stockerData->formPiece->style) > 50 ? '...' : '') : '-')) }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-left: 1px solid;border-right: 1px solid;{{ strlen($stockerData->size) > 5 ? "font-size: 15px;" : "font-size: 60px;" }}text-align: center;' colspan="3" rowspan="3">{{ strtoupper($stockerData->size) }}</td>>
