    ...
    <div style="border: 1px solid;padding: 5px;">
        ...
        <table style="margin-bottom: 5px;">
            <tr>
                ...
                <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;' colspan="4">{{ $stockerData->formCut ? strtoupper(substr($stockerData->formCut->marker->buyer, 0, 100)).(strlen($stockerData->formcut->marker->buyer) > 100 ? '...' : '') : ($stockerData->formReject ? strtoupper(substr($stockerData->formCut->marker->buyer, 0, 100)).(strlen($stockerData->formcut->marker->buyer) > 100 ? '...' : '') : '-') }}</td>
            </tr>
            <tr>
                ...
                <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;'>{{ $stockerData->formCut ?strtoupper(substr($stockerData->formCut->marker->style, 0, 9)).(strlen($stockerData->formCut->marker->style) > 9 ? '...' : '') : ($stockerData->formReject ? strtoupper(substr($stockerData->formCut->marker->style, 0, 100)).(strlen($stockerData->formcut->marker->style) > 100 ? '...' : '') : '-') }}</td>
            </tr>
            <tr>
