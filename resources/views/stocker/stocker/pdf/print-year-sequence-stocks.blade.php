        ...
        <div style="border: 1px solid;padding: 1px">
            ...
            <table style="margin-bottom: 1px;">
                ...
                <tr>
                    ...
                    <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;width:5px;'>:</td>
                    <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;'>{{ strtoupper(substr($stockNumber['color'], 0, 11)).(strlen($stockNumber['color']) > 11 ? '...' : '') }}</td>
                ...
                <tr>
                    <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-left: 1px solid;border-right: 1px solid;{{ strlen($stockNumber["size"]) > 5 ? "font-size: 15px;" : "font-size: 60px;" }}text-align: center;' colspan="3" rowspan="4">{{ strtoupper($stockNumber['size']) }}</td>>
                ...
                <tr>
                    ...
                    <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;width:5px;'>:</td>
                    <td style='border: none;border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;'>{{ $stockNumber['year_sequence'] }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: center;" colspan="3">{{ $stockNumber['updated_at'] }}</td>
                </tr>
            </table>
            {{-- <div class="clearfix">
