    ...
    @foreach ($dataStockers as $dataStocker)
        ...
        <table style="margin-top: -0.5px;">
            ...
            <tr>
                ...
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ $dataStocker->id_qr_stocker }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ $dataStocker->act_costing_ws }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ strtoupper(substr($dataStocker->buyer, 0, 30)).(strlen($dataStocker->buyer) > 30 ? '...' : '') }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ substr($dataStocker->style, 0, 30).(strlen($dataStocker->style) > 30 ? '...' : '') }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ substr($dataStocker->color, 0, 30).(strlen($dataStocker->color) > 30 ? '...' : '') }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ substr($dataStocker->part, 0, 30).(strlen($dataStocker->part) > 30 ? '...' : '') }}</td>
            </tr>
            <tr>
                <td style="width: 16.5%; border: none;border-left: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;white-space: nowrap;">Shade</td>
                <td style="width: 16.5%; border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td style="width: 16.5%; border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ $dataStocker->shade }}</td>
                <td style="width: 16.5%; border: none;border-left: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;white-space: nowrap;">No. Cut</td>
                <td style="width: 16.5%; border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td style="width: auto; border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ $dataStocker->no_cut }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ $dataStocker->dest }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none;border-left: none; border-top: 0.75px solid; border-bottom: 0.75px solid;text-align: center;width: auto;">:</td>
                <td colspan="4" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;{{ strlen($dataStocker->notes) > 30 ? 'font-size: 10px;' : '' }}">{{ substr($dataStocker->notes, 0, 40).(strlen($dataStocker->notes) > 40 ? '...' : '') }}</td>
            </tr>
            <tr>
                ...
                <td style="border: none; border-top: 0.75px solid; border-bottom: 0.75px solid; border-right: 0.75px solid;">&nbsp;</td>
            ...
            <tr>
                ...
                <td colspan="4" style="border: none;border-top: 0.75px solid; border-bottom: 0.75px solid; border-right: 0.75px solid; border-bottom: 0.75px solid;">&nbsp;</td>
            </tr>
        </table>
    @endforeach
</body>
