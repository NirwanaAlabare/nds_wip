    ...
    @foreach ($dataStockers as $dataStocker)
        ...
        <table style="margin-top: -0.5px;">
            ...
            <tr>
                ...
                <td colspan="6" style="border: none;border-right: 0.75px solid; border-top: 0.75px solid; border-bottom: 0.75px solid;">{{ $dataStocker->id_qr_stocker.($dataStocker->id_qr_stocker_old ? " (".$dataStocker->id_qr_stocker_old.")" : "") }}</td>
            </tr>
            <tr>
