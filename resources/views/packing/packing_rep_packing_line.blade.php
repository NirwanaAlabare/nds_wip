    ...
    <div class="card card-sb">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive" id="table_range" style="display: none;">
                <table id="datatable_range" class="table table-bordered table-striped w-100 text-nowrap">
            ...
            <div class="table-responsive" id="table_buyer" style="display: none;">
                <table id="datatable_buyer" class="table table-bordered table-striped w-100 text-nowrap">
