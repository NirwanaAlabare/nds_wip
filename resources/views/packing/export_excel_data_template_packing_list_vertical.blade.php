...
<table class="table">
    <thead>
        <tr>
            ...
            <th style="border:1px solid black;font-weight:bold;text-align: center"> Size</th>
            <th style="border:1px solid black;font-weight:bold;text-align: center"> Qty/CTN</th>
        </tr>
    </thead>
    <tbody>
        <tr>
