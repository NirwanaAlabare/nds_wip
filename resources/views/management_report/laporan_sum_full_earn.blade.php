...
@section('content')
    <div class="card card-sb">
        <div class="card-header">
            <h5 class="card-title fw-bold mb-0"><i class="fas fa-list"></i> Summary (Full Production Earning)</h5>
        </div>
    ...
    <script>
        ...
        function dataTableReload() {
            ...
            let table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('mgt_report_sum_full_earn') }}',
        ...
        function export_excel() {
            ...
            $.ajax({
                type: "get",
                url: '{{ route('export_excel_laporan_sum_full_earn') }}',
                data: {
                ...
                success: function(response) {
                    ...
                    link.download = "Laporan Summary Prod (Full Earning) " + start_date + " _ " + end_date +
                        ".xlsx";
                    link.click();
                },
                error: function(xhr, status, error) {
