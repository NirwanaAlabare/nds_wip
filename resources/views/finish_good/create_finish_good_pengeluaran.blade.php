...
@section('content')
    ...
    <form id="form" name='form' method='post' action="{{ route('store-fg-out') }}"
        onsubmit="submitForm(this, event)">
        <div class="card card-primary">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center ">
                    <h5 class="card-title fw-bold mb-0"><i class="fas fa-user-edit"></i> Input Pengeluaran Barang Jadi /
                        FG
                        OUT
                    </h5>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="card-title"><i class="fas fa-list"></i> Detail Karton</h5>
                        </div>
                        <div class="card-body">
                            <div class="input-group">
                            ...
                            <div class="table-responsive">
                                <table id="datatable_det_karton" class="table table-bordered w-100 text-nowrap">
