    ...
    @if ($page == 'dashboard-dc')
        <script>
            ...
            function exportExcel(elm) {
                ...
                let currentRoute = "{{ route('export-dc-dashboard') }}";

                $.ajax({
                    url: currentRoute,
                    type: 'post',
                    data: {
                        year: $("#dc-year-filter").val(),
                        month: $("#dc-month-filter").val()
                    },
                    xhrFields: {
                        responseType: 'blob'
                    },
                    success: function(res) {
                        ...
                        link.download = "DC Process " + $("#dc-year-filter").val() + " - " + $("#dc-month-filter").val() + ".xlsx";
                        link.click();
                    },
                    error: function(jqXHR) {
                        elm.removeChild(loading);
