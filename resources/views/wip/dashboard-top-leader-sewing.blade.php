        ...
        <div style="position: absolute; bottom: 0;">
            ...
            <div class="d-flex justify-content-center align-items-end" style="width: 100vw; background: #fbfbfb; margin-top: 5vh;">
                ...
                <div id="top-leader-2" class="d-flex flex-column" style="width: 20%;">
                    ...
                    <div style="margin:auto; width: 100px; height: 25vh; background: #238380;" class="mt-3">
                        &nbsp;
                    </div>
                </div>
                {{-- LEADER 1 --}}
                <div id="top-leader-1" class="d-flex flex-column" style="width: 20%;">
                    <div class="profile-frame text-center" style="min-width: 150px !important; width: 150px !important; min-height: 150px !important; height: 150px !important;">
                    ...
                    <div style="margin:auto; width: 100px; height: 35vh; background: #082149;" class="mt-3">
                        &nbsp;
                    </div>
                </div>
                {{-- LEADER 3 --}}
                <div id="top-leader-3" class="d-flex flex-column" style="width: 20%;">
                    <div class="profile-frame text-center" style="min-width: 150px !important; width: 150px !important; min-height: 150px !important; height: 150px !important;">
                    ...
                    <div style="margin:auto; width: 100px; height: 15vh; background: #CD7F32;" class="mt-3">
                        &nbsp;
                    </div>
                </div>
            </div>
