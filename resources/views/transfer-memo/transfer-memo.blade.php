...
<div class="card card-sb">
    <div class="card-header">
        <h5 class="card-title fw-bold mb-0">Data Transfer MEMO</h5>
    </div>
    <div class="card-body">
        <div class="d-flex align-items-end gap-3 mb-3">
            ...
            <div class="mt-4 ">
                <button class="btn btn-primary btn-sm" onclick="dataTableReload()"> <i class="fas fa-search"></i> Search</button>
                <!-- <button class="btn btn-info" onclick="tambahdata()"> <i class="fas fa-plus"></i> Add Data</button> -->
                <a href="{{ route('create-transfer-memo') }}" class="btn btn-info btn-sm">
...
<div class="modal fade" id="modal-cancel-transfer">
    <form action="{{ route('cancel-transfer-memo') }}" method="post" onsubmit="submitForm(this, event)">
         @method('GET')
...
<script>
    let datatable = $("#datatable").DataTable({
        ...
        ajax: {
            ...
            url: '{{ route('transfer-memo-to-exim') }}',
            dataType: 'json',
            dataSrc: 'data',
            data: function(d) {
        ...
        columnDefs: [
            {
                ...
                render: (data, type, row, meta) => {
                    ...
                    if (row.status != 'CANCEL') {
                        return `<div class='d-flex gap-1 justify-content-center'><a href="http://10.10.5.60/ap/module/AP/pdf_transfer_memo.php?doc_number=`+data+`" target="_blank"><button type='button' class='btn btn-sm btn-success'><i class="fa-solid fa-print "></i></button></a>
