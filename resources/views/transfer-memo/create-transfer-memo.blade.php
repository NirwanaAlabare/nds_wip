...
@section('content')
<form action="{{ route('save-transfer-memo') }}" method="post" id="save-transfer-memo" onsubmit="submitForm(this, event)">
    @csrf
        ...
        <div class="form-group row">
            <div class="row">
                <div class="col-3 col-md-3">
                    <div class="mb-1">
                        <div class="form-group">
                            <label><small>No Transfer</small></label>
                ...
                <div class="col-2 col-md-2">
                    <div class="mb-1">
                        <div class="form-group">
                            <label><small>Tgl Transfer</small></label>
                ...
                <div class="col-5 col-md-5">
                    <div class="mb-1">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txt_keterangan" name="txt_keterangan" rows="3" placeholder="Description..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <table id="datatable" class="table table-bordered table-head-fixed w-100 text-nowrap" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">No Memo</th>
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">Tgl Memo</th>
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">Kepada</th>
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">Supplier</th>
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">Jenis Transaksi</th>
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">Jenis Pengiriman</th>
                            <th class="text-center" style="font-size: 0.6rem;width: 300px;">Buyer</th>
...
<div class="mb-1">
    <div class="form-group">
        ...
        <a href="{{ route('transfer-memo-to-exim') }}" class="btn btn-danger float-end mt-2">
    ...
    $(document).on('select2:open', () => {
        ...
        let datatable = $("#datatable").DataTable({
            ...
            ajax: {
                ...
                url: '{{ route('create-transfer-memo') }}',
                dataType: 'json',
                dataSrc: 'data',
                data: function(d) {
            ...
            columns: [
        { data: 'id_h' },              // 0: checkbox
        { data: 'nm_memo' },       // 1
        { data: 'tgl_memo' },         // 2
        { data: 'kepada' },            // 3
        { data: 'supplier' },        // 4
        { data: 'jns_trans' },      // 5
        { data: 'jns_pengiriman' },     // 6
        { data: 'buyer' },              // 7: keterangan
        { data: 'id_h' },       // 8
        { data: 'nm_memo' }             // 9
        ],
        columnDefs: [
        ...
        },
        {
            targets: [9],
            className: "d-none",
            render: (data, type, row, meta) => `<input type="text" id="nm_memo${meta.row}" name="nm_memo[${meta.row}]" value="${data}" readonly style="width:80px;text-align:center;" />`
        }
        ]
    });
