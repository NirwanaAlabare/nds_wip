        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            <ul class="navbar-nav">
                ...
                @if ($page == 'dashboard-cutting')
                    @role('cutting')
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('spreading') }}" class="dropdown-item {{ $routeName == 'spreading' ? 'active' : '' }}">
                                        Spreading <i class="fas fa-scroll fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('form-cut-input') }}" class="appeared dropdown-item {{ $routeName == 'form-cut-input' ? 'active' : '' }}">
                                        Form Cutting <i class="fas fa-cut fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('form-cut-piping') }}" class="dropdown-item {{ $routeName == 'form-cut-piping' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('cut-plan') }}" class="dropdown-item {{ $routeName == 'cut-plan' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPage == 'manage-cutting' ? 'active' : '' }}">Completed Form</a>
                            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('manage-cutting') }}" class="dropdown-item {{ $routeName == 'manage-cutting' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'laporan-cutting' ? 'active' : '' }}">Roll</a>
                            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('lap_pemakaian') }}" class="dropdown-item {{ $subPage == 'lap-pemakaian' ? 'active' : '' }}">
                                        Manajemen Roll <i class="fa-solid fa-toilet-paper fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('sisa_kain_roll') }}" class="dropdown-item {{ $subPage == 'sisa-kain-roll' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'cutting-report' ? 'active' : '' }}">Report</a>
                            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('report-cutting-daily') }}" class="dropdown-item {{ $subPage == 'cutting-daily' ? 'active' : '' }}">
                                ...
                                <li>
                                    <a href="{{ route('pemakaian-roll') }}" class="dropdown-item {{ $routeName == 'pemakaian-roll' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'cutting-piping' ? 'active' : '' }}">Piping</a>
                            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('master-piping') }}" class="dropdown-item {{ $routeName == 'master-piping' ? 'active' : '' }}">
                                        Master <i class="fa-solid fa-gear"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('piping-process') }}" class="dropdown-item {{ $routeName == 'piping-process' ? 'active' : '' }}">
                                        Process <i class="fa-solid fa-ring"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('piping-loading') }}" class="dropdown-item {{ $routeName == 'piping-loading' ? 'active' : '' }}">
                                        Loading <i class="fa-solid fa-right-to-bracket"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('piping-stock') }}" class="dropdown-item {{ $routeName == 'piping-stock' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-stocker')
                    @role('stocker')
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'master-stocker' ? 'active' : '' }}">Master</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('master-part') }}" class="dropdown-item {{ $routeName == 'master-part' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('stocker-part') }}" class="dropdown-item {{ $subPage == 'part' ? 'active' : '' }}">
                                        Part <i class="fas fa-th fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('stocker') }}" class="dropdown-item {{ $routeName == 'stocker' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-dc')
                    @role('dc')
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'dcin-dc' ? 'active' : '' }}">DC In</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('dc-in') }}" class="dropdown-item {{ $routeName == 'dc-in' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'rak-dc' ? 'active' : '' }}">Rak</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('rack') }}" class="dropdown-item {{ $routeName == 'rack' ? 'active' : '' }}">
                                        Master Rak <i class="fa-solid fa-plus-square fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('stock-rack') }}" class="dropdown-item {{ $routeName == 'stock-rack' ? 'active' : '' }}">
                                        Rak <i class="fa-solid fa-table fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('stock-rack-visual') }}" class="dropdown-item {{ $routeName == 'stock-rack-visual' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'stok-dc' ? 'active' : '' }}">Stok DC</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('stock-dc-complete') }}" class="dropdown-item {{ $routeName == 'stok-dc-complete' ? 'active' : '' }}">
                                        Stocker Complete <i class="fa-solid fa-circle-check"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('stock-dc-incomplete') }}" class="dropdown-item {{ $routeName == 'stok-dc-incomplete' ? 'active' : '' }}">
                                        Stocker Incomplete <i class="fa-solid fa-spinner"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('stock-dc-wip') }}" class="dropdown-item {{ $routeName == 'stok-dc-wip' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'trolley-dc' ? 'active' : '' }}">Trolley</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('trolley') }}" class="dropdown-item {{ $routeName == 'trolley' ? 'active' : '' }}">
                                        Master Trolley <i class="fas fa-plus-square fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('stock-trolley') }}" class="dropdown-item {{ $routeName == 'stock-trolley' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('stocker-list') }}" class="dropdown-item {{ $routeName == 'stocker-list' ? 'active' : '' }}">
                                        Stocker List <i class="fa-solid fa-list-ul"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('year-sequence') }}" class="dropdown-item {{ $routeName == 'year-sequence' ? 'active' : '' }}">
                                        Set Year Sequence <i class="fa-solid fa-list-ol"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('modify-year-sequence') }}" class="dropdown-item {{ $routeName == 'modify-year-sequence' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-sewing-eff')
                    @role('sewing')
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'sewing-master' ? 'active' : '' }}">Master</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('master-line') }}" class="dropdown-item {{ $routeName == 'master-line' ? 'active' : '' }}">
                                        Master Line <i class="fa-solid fa-people-group"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('master-plan') }}" class="dropdown-item {{ $routeName == 'master-plan' ? 'active' : '' }}">
                                        Master Plan <i class="fa-solid fa-gears"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('master-defect') }}" class="dropdown-item {{ $routeName == 'master-defect' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'sewing-sewing' ? 'active' : '' }}">Output</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('daily-sewing', ['type' => 'production']) }}" class="dropdown-item {{ $subPage == 'sewing-production' ? 'active' : '' }}">
                                        Daily Sewing Line Output <i class="fa-solid fa-people-line"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('report-hourly') }}" class="dropdown-item {{ $routeName == 'report-hourly' ? 'active' : '' }}">
                                        Hourly Output <i class="fa-solid fa-clock fa-sm"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('daily-sewing', ['type' => 'line-user']) }}" class="dropdown-item {{ $subPage == 'sewing-line-user' ? 'active' : '' }}">
                                ...
                                <li>
                                    <a href="{{ route('undo-output-history') }}" class="dropdown-item {{ $routeName == 'undo-output-history' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                ...
                                <li>
                                    <a href="{{ route('report-defect-in-out') }}" class="dropdown-item {{ $routeName == 'report-defect-in-out' ? 'active' : '' }}">
                                        Report Defect In Out <i class="fa-solid fa-circle-exclamation"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('report-defect') }}" class="dropdown-item {{ $routeName == 'report-defect' ? 'active' : '' }}">
                                        Report Defect <i class="fa-solid fa-file-circle-exclamation"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('defect-map') }}" class="dropdown-item {{ $routeName == 'defect-map' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'sewing-report' ? 'active' : '' }}">Report</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('reportEfficiencynew') }}" class="dropdown-item {{ $subPage == 'reportEfficiencynew' ? 'active' : '' }}">
                                        Report Efficiency <i class="fa-solid fa-file"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('report_mut_output') }}" class="dropdown-item {{ $subPage == 'report_mut_output' ? 'active' : '' }}">
                                        Report Mutasi Output <i class="fa-solid fa-file"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('dashboard-chief-sewing-range', [date('Y-m-d', strtotime(date('Y-m-d') . ' -14 days')), date('Y-m-d')]) }}" class="dropdown-item {{ $routeName == 'dashboard-chief-sewing-range' ? 'active' : '' }}">
                                        Chief Performance <i class="fa-solid fa-file"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('dashboard-leader-sewing', [date('Y-m-d', strtotime(date('Y-m-d') . ' -14 days')), date('Y-m-d')]) }}" class="dropdown-item {{ $routeName == 'dashboard-leader-sewing' ? 'active' : '' }}">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'sewing-wip' ? 'active' : '' }}">WIP</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{ route('line-wip') }}" class="dropdown-item {{ $subPage == 'line-wip' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-warehouse')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Master</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                ...
                @if ($page == 'dashboard-warehouse')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Penerimaan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                ...
                @if ($page == 'dashboard-warehouse')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Pengeluaran</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                ...
                @if ($page == 'dashboard-warehouse')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">QC</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                ...
                @if ($page == 'dashboard-warehouse')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Laporan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                ...
                @if ($page == 'procurement')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Proses</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                ...
                @if ($page == 'dashboard-fg-stock')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'fgstock-masterlokasi' ? 'active' : '' }}">Master</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('master-lokasi-fg-stock') }}" class="dropdown-item {{ $subPage == 'fg-stock' ? 'active' : '' }}">
                                    Master Lokasi <i class="fas fa-search-location fa-sm"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('master-sumber-penerimaan') }}" class="dropdown-item {{ $subPage == 'master-sumber-penerimaan' ? 'active' : '' }}">
                                    Master Sumber Penerimaan <i class="fas fa-indent fa-sm"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('master-tujuan-pengeluaran') }}" class="dropdown-item {{ $subPage == 'master-tujuan-pengeluaran' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'fgstock-bpb' ? 'active' : '' }}">Penerimaan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('bpb-fg-stock') }}" class="dropdown-item {{ $subPage == 'bpb-fg-stock' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'fgstock-bppb' ? 'active' : '' }}">Pengeluaran</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('bppb-fg-stock') }}" class="dropdown-item {{ $subPage == 'bppb-fg-stock' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'fgstock-mutasi' ? 'active' : '' }}">Mutasi</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('mutasi-fg-stock') }}" class="dropdown-item {{ $subPage == 'mutasi-fg-stock' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'fgstock-laporan' ? 'active' : '' }}">Laporan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('laporan-fg-stock') }}" class="dropdown-item {{ $subPage == 'laporan-fg-stock' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-packing')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-transfer-garment' ? 'active' : '' }}">Transfer Garment</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-packing-in' ? 'active' : '' }}">Packing In</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-packing-out' ? 'active' : '' }}">Packing Out</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('needle-check') }}" class="dropdown-item {{ $subPage == 'packing-needle-check' ? 'active' : '' }}">
                                    Needle Checking Scan (Optional)<i class="fa-solid fa-check-double fa-sm"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('packing-out') }}" class="dropdown-item {{ $subPage == 'packing-out' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-master-karton' ? 'active' : '' }}">Master</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            {{-- <li>
                            ...
                            <li>
                                <a href="{{ route('packing-list') }}" class="dropdown-item {{ $subPage == 'packing-list' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-report' ? 'active' : '' }}">Report</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('packing_rep_packing_line_sum') }}" class="dropdown-item {{ $subPage == 'packing_rep_packing_line_sum' ? 'active' : '' }}">
                                    <i class="fas fa-file-upload fa-sm"></i> Summary Packing Line
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('packing_rep_packing_mutasi') }}" class="dropdown-item {{ $subPage == 'packing_rep_packing_mutasi' ? 'active' : '' }}">
                                    <i class="fas fa-file-upload fa-sm"></i> Mutasi Packing List
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('packing_rep_packing_mutasi_wip') }}" class="dropdown-item {{ $subPage == 'packing_rep_packing_mutasi_wip' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard_finish_good')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'finish_good_master_lokasi' ? 'active' : '' }}">Master
                        </a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('finish_good_master_lokasi') }}" class="dropdown-item {{ $subPage == 'finish_good_master_lokasi' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'finish_good_penerimaan' ? 'active' : '' }}">Penerimaan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('finish_good_penerimaan') }}" class="dropdown-item {{ $subPage == 'finish_good_penerimaan' ? 'active' : '' }}">
                                    <i class="fas fa-arrow-circle-left fa-sm" style="color: green;"></i>
                                    Penerimaan Finish Good
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('finish_good_alokasi_karton') }}" class="dropdown-item {{ $subPage == 'finish_good_alokasi_karton' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'finish_good_pengeluaran' ? 'active' : '' }}">Pengeluaran</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('finish_good_pengeluaran') }}" class="dropdown-item {{ $subPage == 'finish_good_pengeluaran' ? 'active' : '' }}">
                                    <i class="fas fa-arrow-circle-right fa-sm" style="color: blue;"></i>
                                    Pengeluaran Finish Good
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('finish_good_retur') }}" class="dropdown-item {{ $subPage == 'finish_good_retur' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-report-doc')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'report-doc-laporan' ? 'active' : '' }}">Laporan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('report-doc-laporan-wip') }}" class="dropdown-item {{ $subPage == 'report-doc-laporan-wip' ? 'active' : '' }}">
                                    Laporan Saldo WIP
                                </a>
                            </li>
                        </ul>
                ...
                @if ($page == 'dashboard-ppic')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'ppic-master' ? 'active' : '' }}">Master</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('master-so') }}" class="dropdown-item {{ $subPage == 'ppic-master-master-so' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'ppic-laporan' ? 'active' : '' }}">Laporan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                            ...
                            <li>
                                <a href="{{ route('ppic_monitoring_order') }}" class="dropdown-item {{ $subPage == 'ppic_monitoring_order' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'ppic-monitoring' ? 'active' : '' }}">Monitoring</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('ppic_monitoring_material') }}" class="dropdown-item {{ $subPage == 'ppic_monitoring_material' ? 'active' : '' }}">
                                    Monitoring Material <i class="fa-solid fa-list-ul fa-sm"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('ppic_monitoring_material_det') }}" class="dropdown-item {{ $subPage == 'ppic_monitoring_material_det' ? 'active' : '' }}">
                                    Monitoring Material Detail <i class="fa-solid fa-list-ul fa-sm"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('ppic_monitoring_material_sum') }}" class="dropdown-item {{ $subPage == 'ppic_monitoring_material_sum' ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('barcode-packing') }}" class="nav-link {{ $routeName == 'barcode-packing' ? 'active' : '' }}" target="_blank">
                            Barcode Packing
                        </a>
                    </li>
                @endif
                ...
                @if ($page == 'dashboard-mut-mesin')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'proses-mut-mesin' ? 'active' : '' }}">Process</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('mut-mesin') }}" class="dropdown-item {{ $subPage == 'mut-mesin' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'master-mut-mesin' ? 'active' : '' }}">Master</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('master-mut-mesin') }}" class="dropdown-item {{ $subPage == 'master-mut-mesin' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'lap-mut-mesin' ? 'active' : '' }}">Laporan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('lap_stok_mesin') }}" class="dropdown-item {{ $subPage == 'lap_stok_mesin' ? 'active' : '' }}">
                                    <i class="fas fa-list fa-sm"></i> List Stok Mesin
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('lap_stok_detail_mesin') }}" class="dropdown-item {{ $subPage == 'lap_stok_detail_mesin' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-ga')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'ga-pengajuan' ? 'active' : '' }}">Pengajuan</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('pengajuan-bahan-bakar') }}" class="dropdown-item {{ $subPage == 'ga-pengajuan-bahan-bakar' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'ga-approval' ? 'active' : '' }}">Approval</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('approval-bahan-bakar') }}" class="dropdown-item {{ $subPage == 'ga-approval-bahan-bakar' ? 'active' : '' }}">
                                    Bahan Bakar <i class="fa-solid fa-gas-pump fa-sm"></i>
                                </a>
                            </li>
                        </ul>
                ...
                @if ($page == 'dashboard-marketing')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'marketing-master' ? 'active' : '' }}">Master</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('master-costing') }}" class="dropdown-item {{ $subPage == 'marketing-master-costing' ? 'active' : '' }}">
