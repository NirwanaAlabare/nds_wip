        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            <ul class="navbar-nav">
                ...
                @if ($page == 'dashboard-marker')
                    @include('marker.marker-nav')
                @endif

                @if ($page == 'dashboard-cutting')
                    @include('cutting.cutting-nav')
                @endif

                @if ($page == 'dashboard-stocker')
                    @include('stocker.stocker-nav')
                @endif
                ...
                @if ($page == 'dashboard-sewing-eff')
                    @include('sewing.sewing-nav')
                @endif

                @if ($page == 'dashboard-export-import')
                ...
                @if ($page == 'dashboard-fg-stock')
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            ...
                            <li>
                                <a href="{{ route('bpb-fg-stock-scan') }}"
                                    class="dropdown-item {{ $subPage == 'bpb-fg-stock-scan' ? 'active' : '' }}">
                                    Penerimaan Barang Jadi Stok Scan <i class="fas fa-box fa-sm"></i>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('bpb-fg-stock-lokasi-scan') }}"
                                    class="dropdown-item {{ $subPage == 'bpb-fg-stock-lokasi-scan' ? 'active' : '' }}">
                ...
                @if ($page == 'accounting')
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('roll_fabric_cutting_in') }}" target="_blank"
                                    rel="noopener noreferrer"
                                    class="dropdown-item {{ $routeName == 'roll_fabric_cutting_in' ? 'active' : '' }}">
                                    Cutting - Penerimaan Fabric
                                </a>
                            </li>
                            <li>
