        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                @if ($page == 'dashboard-cutting')
                    ...
                    @role('cutting')
                        <li class="nav-item dropdown">
                            <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'cuttingplan-cutting' ? 'active' : '' }}">Cutting Plan</a>
                ...
                @if ($page == 'dashboard-dc')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'dcin-dc' ? 'active' : '' }}">DC
                            In</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            @role("dc")
                                <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            @role("dc")
                                <li>
                                    <a href="{{ route('secondary-inhouse') }}" class="dropdown-item {{ $routeName == 'secondary-inhouse' ? 'active' : '' }}">
                                        Secondary Dalam <i class="fas fa-house-user"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('secondary-in') }}" class="dropdown-item {{ $routeName == 'secondary-in' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            @role("dc")
                                <li>
                                    <a href="{{ route('bon-loading-line') }}" class="dropdown-item {{ $routeName == 'bon-loading-line' ? 'active' : '' }}">
                ...
                @if ($page == 'dashboard-packing')
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-transfer-garment' ? 'active' : '' }}">Transfer
                            Garment</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-packing-in' ? 'active' : '' }}">Packing
                            In</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="{{ route('packing-in') }}" class="dropdown-item {{ $subPage == 'packing-in' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" aria-haspopup="true"aria-expanded="false" class="nav-link dropdown-toggle {{ $subPageGroup == 'packing-packing-out' ? 'active' : '' }}">Packing
                            Out</a>
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li>
