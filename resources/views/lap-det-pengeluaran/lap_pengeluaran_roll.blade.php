    ...
    <form action="{{ route('export_excel_pengeluaranroll') }}" method="get">
        <div class="card card-sb">
            <div class="card-header">
                <h5 class="card-title fw-bold mb-0"><i class="fas fa-file-alt fa-sm"></i> Laporan Pengeluaran Detail Per Roll</h5>
            </div>
            <div class="card-body">
...
@section('custom-script')
    ...
    <script>
        ...
        function export_excel() {
            ...
            $.ajax({
                type: "get",
                url: '{{ route('export_excel_pengeluaranroll') }}',
                data: {
                    from: from,
                    to: to
                },
                ...
                success: function(response) {
                    {
                        ...
                        link.download = "Laporan Pengeluaran Detail Roll Dari  " + from + " sampai " +
                            to + ".xlsx";
                        link.click();
