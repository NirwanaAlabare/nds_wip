...
<div class="card card-sb">
    ...
    <form action="{{ route('dokumen-pabean-update_draft_batch_bc262', $batch_id) }}" method="POST" id="form-edit-ceisa">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="alert alert-warning py-2 mb-4">
                <strong>Mode Batch (BC 2.6.2)</strong><br>
                ...
                <div class="tab-pane fade" id="tab-kemasan" role="tabpanel">
                    ...
                    <div class="card shadow-sm mb-3 border">
                        <div class="card-header fw-bold d-flex align-items-center px-3 py-2 bg-light text-dark" style="font-size:13px;">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-light py-0 px-2" style="margin-left: auto !important;" id="btn-add-kontainer" title="Tambah Kontainer"><i class="fas fa-plus"></i> Tambah Petikemas</button>
                        </div>
                        <div class="card-body p-0">
                            @php
                            ...
                            <div class="card shadow-sm mb-3 border">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" step="any" name="nilaiPabean" class="form-control form-control-sm" value="{{ $dataDetail['nilaiPabean'] ?? '0.00' }}" id="nilai_pabean">
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="card shadow-sm mb-3 border">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group mb-2">
                                                                <label>Nilai CIF</label>
                                                                <input type="number" step="any" name="barang[{{ $index }}][cif]" class="form-control form-control-sm mb-2 input-cif-barang" value="{{ $draftItem['cif'] ?? '0.00' }}">
                                                            </div>
                                                            <div class="form-group mb-0">
