...
<div class="card card-sb">
    ...
    <form action="{{ route('dokumen-pabean-update_draft_bc261', $header->bppbno ?? $header->trx_no_par) }}" method="POST" id="form-edit-ceisa" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="card shadow-sm mb-3 border">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group mb-2">
                                                                <label>Nilai CIF</label>
                                                                <input type="number" step="any" name="barang[{{ $index }}][cif]" class="form-control form-control-sm" value="{{ $draftItem['cif'] ?? '0.00' }}">
                                                            </div>
                                                            <div class="form-group mb-0">
                                                                <label>Nilai CIF</label>
