                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="kodeJenisEkspor" class="form-control form-control-sm select2bs4">
                                                @php $jenisEkspor = $dataDetail['kodeJenisEkspor'] ?? '1' @endphp
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="kodeKategoriEkspor" class="form-control form-control-sm select2bs4">
                                                @php $katEkspor = $dataDetail['kodeKategoriEkspor'] ?? '10' @endphp
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="kodeCaraDagang" class="form-control form-control-sm select2bs4">
                                                @php $caraDagang = $dataDetail['kodeCaraDagang'] ?? '1' @endphp
                                                <option value="1" {{ $caraDagang == '1' ? 'selected' : '' }}>1 - BIASA</option>
                                                <option value="15" {{ $caraDagang == '15' ? 'selected' : '' }}>15 - LAINNYA</option>
                                                <option value="2" {{ $caraDagang == '2' ? 'selected' : '' }}>2 - IMB IMBAL BARANG</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="kodeCaraBayar" class="form-control form-control-sm select2bs4">
                                                @php $caraBayar = $dataDetail['kodeCaraBayar'] ?? '1' @endphp
                                                ...
                                                <option value="13" {{ $caraBayar == '13' ? 'selected' : '' }}>13 - DILAKUKAN DI DN DENGAN PEMBAYARAN MELALUI TELEGRAPH TRANSFER (T/T)</option>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="border rounded px-3 pb-3 mb-3 bg-white">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control form-control-sm " name="kesiapanBarang[0][kodeJenisGudang]">
                                        ...
                                        <div class="form-group row mb-0">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control form-control-sm " name="kesiapanBarang[0][kodeJenisBarang]">
                                ...
                                <tbody id="tbody-dokumen">
                                    ...
                                    @foreach($dokumens as $index => $dok)
                                        <tr>
                                            ...
                                            <td>
                                                @if(!empty($dok['fileName']))
                                                    <a href="{{ str_replace('/index.php', '', url('uploads/ceisa/' . $dok['fileName'])) }}" class="btn btn-sm btn-outline-info py-0 px-2" target="_blank">
                                                        <i class="fas fa-file-alt"></i> Lihat File
                                                    </a>
                                                @else
                                                    <input type="file" name="dok[{{ $index }}][file_lampiran]" class="form-control-file form-control-sm" accept=".pdf,.jpg,.jpeg,.png">
                                                @endif
                                                <input type="hidden" name="dok[{{ $index }}][fileName]" value="{{ $dok['fileName'] ?? '' }}">
                                            </td>
        ...
        $('#btn-add-dok').on('click', function() {
            let htmlTr = `
                <tr>
                    ...
                    <td><input type="file" name="dok[${dokIndex}][file_lampiran]" class="form-control-file form-control-sm" accept=".pdf,.jpg,.jpeg,.png"></td>
