    ...
    <div class="card card-sb">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="{{ route('track-ws') }}" class="home-item" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-sb mb-0"><i class="fa-solid fa-gears"></i> Track Worksheet</h5>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('inject-adjustment') }}" class="home-item" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-sb mb-0"><i class="fa-solid fa-gears"></i> Inject Adjustment</h5>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('switching') }}" class="home-item" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-sb mb-0"><i class="fa-solid fa-gears"></i> Switching</h5>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="{{ route('lock') }}" class="home-item" target="_blank">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-sb mb-0"><i class="fa-solid fa-gears"></i> Lock</h5>
                            </div>
                        </div>
                    </a>
                </div>
