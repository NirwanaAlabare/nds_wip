                ...
                <tr>
                    @if ($currentLine != $line->username)
                        <td rowspan="{{ $currentRowSpan }}" style="text-align: center; vertical-align: middle;">
                            <a href="http://10.10.5.62:8000/dashboard-wip/line/dashboard1/{{ $line->username }}" target="_blank">
        ...
        @else
            @foreach ($orders as $order)
                ...
                <tr>
                    ...
                    @endif
                    <td>
                        <a href="http://10.10.5.62:8000/dashboard-wip/line/dashboard1/{{ $order->username }}" target="_blank">
