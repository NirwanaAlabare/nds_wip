<table class="table table-bordered">
    ...
    <tr>
        <td colspan="{{ ($groupBy == "size" ? 6 : 5) + $orderOutputs->sortBy("tanggal")->groupBy("tanggal")->count() }}" style="text-align: center; font-weight: 800;">{{ $buyer ? "'".$buyerName."'" : '' }} {{ $order ? "'".$order."'" : '' }} Output {{ $outputType ? strtoupper(str_replace("_", "", $outputType)) : "SEWING" }}</td>
    </tr>
