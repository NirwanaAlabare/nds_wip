<table>
    <tr>
        <td style="text-align: start; font-weight: 800;" colspan="3">Top Defect {{ $department == "_packing" ? "Packing" : "QC" }} {{ $dateFrom." s/d ".$dateTo }}</td>
    </tr>
    <tr>
        <td style="text-align: start; font-weight: 800;" colspan="3">WS : {{ $ws }}</td>
    </tr>
    <tr>
        <td style="text-align: start; font-weight: 800;" colspan="3">Style : {{ $ws ? $topDefect->groupBy("style")->keys()->implode(", ") : $style }}</td>
    </tr>
    <tr>
