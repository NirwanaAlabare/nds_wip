...
@section('custom-link')
    ...
    <style>
        ...
        .bg-light-rework { background-color: #fff9ec !important; }
    </style>
@endsection
...
<div class="card card-sb">
    <div class="card-header">
        <h5 class="card-title fw-bold mb-0"><i class="fas fa-sync-alt"></i> Report Rework Sewing</h5>
    </div>
    <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#datatable').DataTable({
            ...
            ajax: {
                url: "{{ route('report-sewing.rework.data') }}",
                data: function(d) {
    ...
    function exportExcel() {
        ...
        Swal.fire(
            { title: 'Menyiapkan Excel...', allowOutsideClick: false, didOpen: () => { Swal.showLoading(); }
        });
        window.location.href = `{{ route('report-sewing.rework.export') }}?start_date=${start}&end_date=${end}&buyer=${encodeURIComponent(buyer)}`;
