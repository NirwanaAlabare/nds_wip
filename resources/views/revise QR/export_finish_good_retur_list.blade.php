...
<table class="table">
    <tr>
        <td colspan='16'>Laporan FG Retur List</td>
    </tr>
    <tr>
    ...
    <thead>
        <tr>
            <th style="background-color: yellow;border:1px solid black;font-weight:bold">No. SB</th>
            ...
            <th style="background-color: yellow;border:1px solid black;font-weight:bold">Inv / SJ</th>
            <th style="background-color: yellow;border:1px solid black;font-weight:bold">Jenis Dok</th>
