...
@section('content')
    <form id="form_del" name='form_del' method='post' action="{{ route('delete_karton_fg_out') }}"
    ...
    <form id="form" name='form' method='post' action="{{ route('edit-store-fg-out') }}"
        onsubmit="submitForm(this, event)">
        <div class="card card-primary">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center ">
                    <h5 class="card-title fw-bold mb-0"><i class="fas fa-user-edit"></i> Edit Pengeluaran Barang Jadi /
                        FG
                        OUT
                    </h5>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="form-label"><small><b>No. SB :</b></small></label>
                            <input type="text" class="form-control form-control-sm " id="bppbno" name="bppbno"
                                value="{{ $no_sb }}" readonly>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm " id="cbobuyer" name="cbobuyer"
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4" id="cbotipe_doc" name="cbotipe_doc" style="width: 100%;"
                                required>
                                <option selected="selected" disabled="true">Pilih Dokumen
                                </option>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="txtinv" name="txtinv"
                                value ="{{ $inv }}" style="width: 100%;" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="card-title"><i class="fas fa-list"></i> Detail Karton Tambahan</h5>
                        </div>
                        <div class="card-body">
                            <div class="input-group">
                ...
                <div class="col-md-5">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="card-title"><i class="fas fa-list"></i> Summary Tambahan</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="card-title"><i class="fas fa-check"></i> Detail Karton Terinput</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                ...
                <div class="col-md-5">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="card-title"><i class="fas fa-check"></i> Summary Terinput</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
...
@section('custom-script')
    ...
    <script>
        $(document).ready(function() {
            $("#cbotipe_doc").val('BC 4.1').trigger('change');
            ...
            cleartmp();
            getpo();
            dataTableDetTerinputKartonReload();
            dataTableSummaryTerinputReload();
        })

        function cleartmp() {
            $.ajax({
                type: "post",
                url: '{{ route('clear_tmp_fg_out') }}',
        ...
        function getnotes() {
            ...
            let html = $.ajax({
                type: "GET",
                url: '{{ route('getcarton_notes_fg_out') }}',
                data: {
                    cbobuyer: cbobuyer,
                    cbopo: cbopo
                },
        ...
        function getno_carton() {
            ...
            jQuery.ajax({
                url: '{{ route('show_number_carton_fg_out') }}',
                method: 'GET',
                data: {
                    cbopo: cbopo,
                    cbonotes: cbonotes
        ...
        let datatable_det_karton = $("#datatable_det_karton").DataTable({
            ...
            ajax: {
                ...
                url: '{{ route('show_det_karton_fg_out') }}',
                dataType: 'json',
                dataSrc: 'data',
                data: function(d) {
        ...
        let datatable_summary = $("#datatable_summary").DataTable({
            ...
            ajax: {
                ...
                url: '{{ route('show_summary_karton_fg_out') }}',
                dataType: 'json',
                dataSrc: 'data',
            },
            columns: [{
        ...
        let datatable_delete = $("#datatable_delete").DataTable({
            ...
            ajax: {
                ...
                url: '{{ route('show_delete_karton_fg_out') }}',
                dataType: 'json',
                dataSrc: 'data',
            },
            columns: [{
        ...
        function dataTableDetTerinputKartonReload() {
            datatable_det_terinput_karton.ajax.reload();
        }

        let datatable_det_terinput_karton = $("#datatable_det_terinput_karton").DataTable({
            "footerCallback": function(row, data, start, end, display) {
                var api = this.api(),
                    data;
            ...
            ajax: {
                ...
                url: '{{ route('show_det_karton_fg_out_terinput') }}',
                dataType: 'json',
                dataSrc: 'data',
                data: function(d) {
                    d.bppbno = $('#bppbno').val();
        ...
        function dataTableSummaryTerinputReload() {
            datatable_summary_terinput.ajax.reload();
        }

        let datatable_summary_terinput = $("#datatable_summary_terinput").DataTable({
            "footerCallback": function(row, data, start, end, display) {
                var api = this.api(),
                    data;
            ...
            ajax: {
                ...
                url: '{{ route('show_summary_karton_fg_out_terinput') }}',
                dataType: 'json',
                dataSrc: 'data',
                data: function(d) {
                    d.bppbno = $('#bppbno').val();
