    ...
    <form id="form" name='form' method='post' action="{{ route('store-fg-in') }}"
        ...
        <div class="card card-sb ">
            <div class="card-header">
                <h5 class="card-title fw-bold mb-0"><i class="fas fa-user-check"></i> Input QR</h5>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label"><small><b>Nomor QR</b></small></label>
                            <input type="text" class="form-control form-control-sm" id="txtqr" name="txtqr"
                                style="width: 100%;">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label"><small><b>New Size</b></small></label>
                            <input type="text" class="form-control form-control-sm" id="txtsize" name="txtsize"
                                style="width: 100%;">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <a onclick="cek_qr()" class="btn btn-outline-primary position-relative btn-sm">
