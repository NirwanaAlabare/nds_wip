...
@section('content')
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <form action="{{ route('store-master-tujuan-pengeluaran') }}" method="post" onsubmit="submitForm(this, event)"
            name='form' id='form'>
            @method('POST')
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header bg-sb text-light">
                        <h3 class="modal-title fs-5">Tambah Tujuan Pengeluaran</h3>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label">Tujuan Pengeluaran :</label>
                            <input type='text' class='form-control form-control-sm' id="txttujuan" name="txttujuan"
    ...
    <div class="card card-sb">
        <div class="card-header">
            <h5 class="card-title fw-bold mb-0"> <i class="fas fa-outdent"></i> Master Tujuan Pengeluaran</h5>
        </div>
        <div class="card-body">
            <div class="mb-3">
...
@section('custom-script')
    ...
    <script>
        let datatable = $("#datatable").DataTable({
            ...
            searching: true,
            ajax: {
                url: '{{ route('master-tujuan-pengeluaran') }}',
            },
