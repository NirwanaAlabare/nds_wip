...
@section('content')
    <div class="card card-sb">
        <div class="card-header">
            <h5 class="card-title fw-bold mb-0"><i class="fas fa-box-open"></i> Report Ganti Reject Set</h5>
        </div>
        <div class="card-body">
...
@section('custom-script')
    ...
    <script>
        ...
        function export_excel() {
            ...
            $.ajax({
                type: "get",
                url: '{{ route('export_excel_report_gr_set') }}',
                data: {
                ...
                success: function(response) {
                    ...
                    link.download = "Laporan GR Set " + start_date + " _ " + end_date +
                        ".xlsx";
                    link.click();
                },
