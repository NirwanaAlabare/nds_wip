...
@section('content')
    <div class="card card-sb">
        <div class="card-header">
            <h5 class="card-title fw-bold mb-0"><i class="fas fa-list"></i> Report Mutasi WIP Cutting Set</h5>
        </div>
    ...
    <script>
        ...
        function dataTableReload() {
            ...
            const table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: '{{ route('report_mutasi_wip_cutting_set') }}',
                    data(d) {
        ...
        function export_excel() {
            ...
            $.ajax({
                type: "get",
                url: '{{ route('export_excel_report_mutasi_wip_cutting_set') }}',
                data: {
                ...
                success: function(response) {
                    ...
                    link.download = "Laporan Mutasi WIP Cutting Set " + start_date + " _ " + end_date + ".xlsx";
                    link.click();
                },
