...
@section('content')
    ...
    <form action="{{ route('store-cutting-reject') }}" method="post" id="store-cutting-form-reject"
    ...
    <div class="card card-sb  d-none" id="cardInputFabric">
        <div class="card-header">
        ...
        function startProcess(element) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    document.getElementById('cardInputFabric').classList.remove('d-none');
