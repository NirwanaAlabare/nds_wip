            ...
            <div class="card card-sb" id="header-data-card">
                ...
                <div class="card-body" style="display: block;">
                    ...
                    <div class="row align-items-end">
                        ...
                        <input type="hidden" name="selectmethod_locked" id="selectmethod_locked" value="{{ $formCutInputData->select_method_locked }}" readonly>
                        <input type="hidden" name="selectmethod_unlocked_by" id="selectmethod_unlocked_by" value="{{ $formCutInputData->select_method_unlocked_by }}" readonly>
                        <input type="hidden" name="multiple_locked_type" id="multiple_locked_type" value="{{ ($formCutInputData->locked ? "shortroll" : "") . ($formCutInputData->cons_locked ? ",consmarker" : "") . ($formCutInputData->select_method_locked ? ",selectmethod" : "")}}" readonly>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">No. WS</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">No. Form</label>
                                <input type="text" class="form-control form-control-lg border-fetch" name="no_form" id="no_form" value="{{ $formCutInputData->no_form }}" readonly>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Panel</label>
                                <input type="text" class="form-control form-control-lg border-fetch" name="panel" id="panel" value="{{ $formCutInputData->panel }}" readonly>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Color</label>
                                <input type="text" class="form-control form-control-lg border-fetch" name="color" id="color" value="{{ $formCutInputData->color }}" readonly>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Buyer</label>
                                <input type="text" class="form-control form-control-sm border-fetch" name="buyer" value="{{ $thisActCosting->buyer }}" readonly>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Style</label>
                                <input type="text" class="form-control form-control-sm border-fetch" name="style" value="{{ $thisActCosting->style }}" readonly>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">PO</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Tipe Marker</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Urutan Form</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">QTY Gelar Marker</label>
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-text border-fetch">Ply</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">QTY Cut Ply</label>
                                <div class="input-group input-group-sm">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Color Fabric</label>
                                <input type="text" class="form-control form-control-sm border-fetch" id="color_fabric" name="color_fabric" value="{{ $formCutInputData->color }}" readonly>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                ...
                <div class="card-body" style="display: block;">
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Panjang Marker</label>
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Comma Marker</label>
                                <div class="input-group">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Lebar Marker</label>
                                <div class="input-group">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Lebar WS</label>
                                <div class="input-group">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Cons. Marker</label>
                                <div class="input-group">
                                    ...
                                    >
                                    <input type="text" class="form-control form-control-sm border-fetch" name="unit_cons_marker" id="unit_cons_marker" onchange="updateConsMarkerUnit()" value="{{ $formCutInputData->unit_cons_marker }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Cons. Piping</label>
                                <div class="input-group">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Gramasi</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-fetch" name="unit_gramasi" id="unit_gramasi" value="gr/m²" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6 d-none">
                        ...
                        <div class="col-md-12" id="scan-method">
                            <div class="row align-items-end">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label small label-scan">Item</label>
                                        <div class="input-group">
                        ...
                        <div class="row">
                                ...
                                <div class="d-flex gap-3">
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="number" class="form-control form-control-sm border-scan" style="width: 60%" id="current_qty_awal" name="current_qty_awal" readonly>
                                                <input type="text" class="form-control form-control-sm border-scan" style="width: 40%;" id="current_unit_awal" name="current_unit_awal" value="METER" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex mb-3">
                                                <div class="input-group input-group-sm">
                                                    <input type="number" class="form-control form-control-sm border-calc" style="width: 60%;" id="current_qty" name="current_qty" readonly>
                                                    <input type="text" class="form-control form-control-sm border-calc" style="width: 40%;" id="current_unit_convert" name="current_unit_convert" value="METER" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="number" class="form-control form-control-sm border-input" style="width: 60%;" id="current_sisa_gelaran" name="current_sisa_gelaran" step=".01"
                                            onkeyup="
                                                // restrictRemainPly();
                                                calculateShortRoll(event);
                                                calculatePemakaianLembar();
                                            ...
                                            onchange="
                                                ...
                                                calculateTotalPemakaian();
                                            ">
                                        <input type="text" class="form-control form-control-sm border-input" style="width: 40%;" id="current_sisa_gelaran_unit" name="current_sisa_gelaran_unit" step=".01" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <input type="number" class="form-control form-control-sm border-input"
                                            id="current_sambungan" name="current_sambungan" step=".01" style="width: 60%;"
                                            onkeyup="
                                                calculateShortRoll(event);
                                                calculatePemakaianLembar();
                                                calculateTotalPemakaian();
                                        ...
                                        <input type="text" class="form-control form-control-sm border-input"
                                            id="current_sambungan_unit" name="current_sambungan_unit" step=".01" style="width: 40%;"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <span class="input-group-text border-calc">Ply</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="number" class="form-control form-control-sm border-sb" id="current_lembar_gelaran" name="current_lembar_gelaran" readonly
                                                    ...
                                                    onchange="
                                                        ...
                                                        // calculateSisaKain();
                                                    ">
                                                <span class="input-group-text border-sb">Ply</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="col-6 col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <span class="input-group-text input-group-unit border-calc"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="row align-items-end">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label small label-calc">Kenaikan Cons. WS</label>
                                        <div class="input-group input-group-sm mb-3">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label small label-calc">Kenaikan Cons. Marker</label>
                                        <div class="input-group input-group-sm mb-3">
                                ...
                                <div class="col-sm-6 col-md-3 d-none">
                                    <div class="mb-3">
                                        <label class="form-label small label-calc">Cons. Actual Tanpa Short Roll</label>
...
@section('custom-script')
    ...
    <script>
        ...
        // Process :
            ...
            function calculateConsActualGelaran(unit, totalQtyFabric, totalKepalaKain, totalSisaTidakBisa, totalReject, totalSisaKain, totalPiping, totalShortRoll, totalLembar, totalTotalPemakaian, totalSambunganRoll) {
                let unitVar = unit;
            ...
            async function checkStatus() {
                ...
                if ($("#locked").val() > 0) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Form terkunci karena Short Roll kurang dari -2%',
                        html: `
                            Harap laporkan kepada atasan untuk dapat melanjutkan
                            <input type='text' class='my-3 form-control form-control-sm' id='unlock_form_username' placeholder='Masukkan username...' onkeyup='unlockEnter(event)'>
                            <input type='password' class='my-3 form-control form-control-sm' id='unlock_form_password' placeholder='Masukkan password...' onkeyup='unlockEnter(event)'>
        ...
        // Function List :
            ...
            function appendScannedItem(data) {
                ...
                Number(data.short_roll) < 0 ? totalShortRoll += (latestStatus != 'extension complete' ? Number((data.total_pemakaian_roll ? data.total_pemakaian_roll : 0) + ( data.sisa_kain ? data.sisa_kain : 0 ) - ( data.qty ? data.qty : 0 )).round(2) : Number((data.total_pemakaian_roll ? data.total_pemakaian_roll : 0) + (latestTotalPemakaian ? latestTotalPemakaian : 0) + ( data.sisa_kain ? data.sisa_kain : 0 ) - ( latestQty ? latestQty : 0 )).round(2)) : 0;
        ...
        // Sambungan Module
            ...
            async function setSambungan(data) {
                ...
                data.forEach((element, index, array) => {
                    ...
                    divCol1.innerHTML=`
                        `+(index == 0 ? `<label class="form-label small">Sambungan Roll` : `` )+`
                        <div class="input-group input-group-sm">
