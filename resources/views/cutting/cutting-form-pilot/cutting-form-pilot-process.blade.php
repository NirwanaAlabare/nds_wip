                ...
                <div class="card-body" style="display: block;">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label label-fetch">No. Form</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label label-fetch">Panel</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label label-fetch">Color</label>
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">No. Urut Form</label>
                                <input type="text" class="form-control form-control-sm border-fetch" id="no_urut_form" value="{{ $formCutInputData->urutan_marker." / ".$formCutInputData->nomor }}" readonly>
                            </div>
                        </div>
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                        ...
                        <div class="col-4 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm border-fetch" name="color-fabric" id="color-fabric" value="{{ $formCutInputData->color }}" readonly>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                <label class="form-label small label-fetch">Catatan</label>
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm border-calc" name="unit_cons_act" id="unit_cons_act" value="{{ $formCutInputData->unit_cons_ampar ? $formCutInputData->unit_cons_ampar : 'METER' }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    >
                                    <input type="text" class="form-control form-control-sm border-fetch" name="unit_cons_pipping" id="unit_cons_pipping" value="{{ $formCutInputData->unit_cons_pipping ? $formCutInputData->unit_cons_pipping : 'METER' }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <span class="input-group-text border-fetch">gr/cm²</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-12" id="scan-method">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label small label-input">Color Act</label>
                                ...
                                <div class="row">
                                    <div class="col d-none" id="berat_amparan">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group input-group-sm">
                                                <input type="number" class="form-control form-control-sm" id="current_berat_amparan" name="current_berat_amparan" step=".01" value="0"
                                                    onkeyup="
                                                        calculateSambungan();
                                                        calculateShortRoll(event);
                                                        calculatePemakaianLembar();
                            ...
                            <div class="col-md-6" id="total-sambungan-section">
                                <div class="row row-gap-3 align-items-end mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control form-control-sm" id="current_total_sambungan_roll" name="current_total_sambungan_roll" readonly onchange="calculatePemakaianLembar();calculatePemakaianLembar();calculateTotalPemakaian();calculateShortRoll(event);/*calculatePemakaianLembar();*/">
                                    </div>
                                    <div class="col-md-6">
    ...
    <script>
        ...
        // Process :
            ...
            function calculateConsActualGelaran(unit, totalQtyFabric, totalKepalaKain, totalSisaTidakBisa, totalReject, totalSisaKain, totalPiping, totalShortRoll, totalLembar, totalTotalPemakaian) {
                ...
                let consActualGelaran = (totalLembarVar * totalRatio) ? (totalQtyFabricVar - totalSisaKainVar)/(totalLembarVar * totalRatio) : 0;
                let consActualGelaranShortRolless = (totalLembarVar * totalRatio) ? (totalQtyFabricVar - totalSisaKainVar + totalShortRollVar)/(totalLembarVar * totalRatio) : 0;
