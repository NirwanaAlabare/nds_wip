...
@section('content')
    <div class="row g-3 mb-3">
        <div class="d-flex gap-3 align-items-center">
            <h5 class="mb-1">Form Cut Pilot - {{ strtoupper($formCutData->name) }}</h5>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm border-fetch" value="{{ $formCutData->kode }}" readonly>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control border-fetch" name="marker_notes" rows="2" readonly>{{ $formCutData->notes }}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body" style="display: block;">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-3">
                                <label class="form-label label-input"><small><b>Unit Act</b></small></label>
                                <input type="text" class="form-control form-control-sm border-input" name="unit_l_act" id="unit_l_act" value="{{ strtoupper($formCutData->unit_lebar_marker) }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm border-fetch" name="gramasi" id="gramasi" value="{{ $formCutData->gramasi }}"
                        ...
                        <div class="col-6 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm border-fetch" name="cons_marker" id="cons_marker" value="{{ $formCutData->cons_marker }}"
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control form-control-sm border-fetch" step=".01" name="cons_pipping" id="cons_pipping" value="{{ $formCutData->cons_pipping ? $formCutData->cons_pipping : '0' }}" readonly
