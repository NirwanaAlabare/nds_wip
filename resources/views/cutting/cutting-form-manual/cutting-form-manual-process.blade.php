                ...
                <div class="card-body" style="display: block;">
                    ...
                    <form action="{{ route('store-marker-manual-form-cut') }}" method="post" onsubmit="submitMarkerForm(this, event)" id="store-marker">
                        <div class="row align-items-end">
                            ...
                            <input type="hidden" name="no_meja" id="{{ Auth::user()->type != 'admin' && Auth::user()->type != 'superadmin' ? 'no_meja' : 'no_meja_text' }}" value="{{ isset($formCutInputData) ? ($formCutInputData->no_meja ? $formCutInputData->no_meja : (Auth::user()->type != 'admin' && Auth::user()->type != 'superadmin' ? Auth::user()->id : '')) : (Auth::user()->type != 'admin' && Auth::user()->type != 'superadmin' ? Auth::user()->id : '') }}" {{ Auth::user()->type != 'admin' && Auth::user()->type != 'superadmin' ? '' : 'disabled' }}>
