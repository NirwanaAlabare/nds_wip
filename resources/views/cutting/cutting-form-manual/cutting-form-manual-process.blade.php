    ...
    // Form Cut Script
        ...
        // Process :
            ...
            function calculateShortRoll() {
                ...
                console.log(qtyVar, (pActualConverted * lembarGelaranVar), sambunganVar + sisaGelaranVar + sambunganRollVar + kepalaKainVar + sisaTidakBisaVar + rejectVar + sisaKainVar + pipingVar, shortRoll)
