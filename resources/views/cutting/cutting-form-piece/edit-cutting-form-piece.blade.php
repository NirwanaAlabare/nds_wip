...
@section('content')
    ...
    <div class="d-flex justify-content-between mb-3">
        <h5 class="text-sb fw-bold">{{ $currentCuttingPiece ? $currentCuttingPiece->no_form : null }}</h5>
    ...
    {{-- PROCESS ONE --}}
        <form action="{{ route('update-cutting-piece') }}" method="POST" id="process-one-form" onsubmit="processOne(this, event)">
                ...
                <div class="card-body">
                    ...
                    <div class="row row-gap-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="hidden" class="form-control d-none" id="panel_val" name="panel_val" value="{{ $currentCuttingPiece ? $currentCuttingPiece->panel : null }}">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="employee_id" id="employee_id" value="{{ $currentCuttingPiece ? $currentCuttingPiece->employee_id : null }}" readonly>
    ...
    <script>
        ...
        // PROCESS ONE
            ...
            function updatePanelList() {
                ...
                return $.ajax({
                    ...
                    success: function (res) {
                        if (res && res.length > 0) {
                            // current value
                            let currentPanel = $("#panel_val").val();
                            ...
                            $("#panel").val((currentPanel ? currentPanel : res[0].panel)).trigger("change");
                        } else {
            ...
            function processOne(e, event) {
                ...
                $.ajax({
                    url: '{{ route('update-cutting-piece') }}',
                    type: 'put',
                    data: dataObj,
                    dataType: "json",
