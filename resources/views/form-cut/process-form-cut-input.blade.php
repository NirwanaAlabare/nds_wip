                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control form-control-sm border-fetch" step=".01"
                                    name="cons_pipping" id="cons_pipping" value="{{ $formCutInputData->cons_piping }}"
                                    readonly onkeyup="calculateEstPipping(this.value)"
    ...
    <script>
        ...
        function calculateEstAmpar() {
            ...
            if (unitQtyVar != "KGM") {
                ...
                pActualConverted = pActualConversion(pActualVar, unitPActualVar, commaActualVar, lActualVar, gramasiVar,
                    unitQtyVar);
            }
        ...
        function calculateShortRoll() {
            ...
            let shortRoll = qtyVar - ((pActualConverted * lembarGelaranVar) + sisaGelaranVar + sambunganVar +
        ...
        function calculateRemark() {
            ...
            let remark = ((pActualConverted * lembarGelaranVar) + sisaGelaranVar + kepalaKainVar + sisaTidakBisaVar +
        ...
        function calculateConsActualGelaran(unit = 0, piping = 0, lembar = 0, totalQtyFabric = 0, totalQtyCut = 0,
            totalPemakaian) {
            let unitVar = unit;
            ...
            if (checkIfNull(unitVar) && checkIfNull(pipingVar) && checkIfNull(lembarVar) && checkIfNull(pActualVar) &&
                ...
                if (document.getElementById("status_sambungan").value == "extension") {
                    ...
                    if (unitVar != "KGM") {
                        ...
                        pActualConverted = pActualConversion(pActualVar, unitPActualVar, commaActualVar, lActualVar,
                            gramasiVar, unitVar);
                    }
                }
        ...
        function setSpreadingForm(data, sisaGelaran) {
            ...
            data.unit ? document.getElementById("current_sisa_gelaran_unit").value = (data.unit != "KGM" ? "METER" :
                "KGM") : '';
            ...
            if (sisaGelaran > 0) {
                ...
                document.getElementById("current_total_pemakaian_roll").value = document.getElementById("current_sambungan")
                    .value;
            } else {
                nextProcessThreeButton.classList.add("d-none");
        ...
        function updatePlyProgress() {
            ...
            document.getElementById("current_ply_progress").style.width = Number(qtyPly) > 0 ? (Number(totalLembar +
        ...
        function appendScannedItem(data) {
            ...
            calculateConsActualGelaran(unit = latestUnit, piping = totalPiping, lembar = totalLembar, totalQtyFabric,
        ...
        async function setLostTime(data) {
            await data.forEach((element, index, array) => {
                ...
                td2.innerHTML = element.waktu;
                td3.classList.add('d-none');
                td3.innerHTML = `<input type='hidden' name="lost_time[` + lostTime + `]" value="` + element
                    .waktu + `" />`;
                tr.appendChild(td1);
                tr.appendChild(td2);
                tr.appendChild(td3);
        ...
        async function addNewLostTime() {
            ...
            td3.classList.add('d-none');
            td3.innerHTML = `<input type='hidden' name="lost_time[` + lostTime + `]" value="` + lostMinutes.value +
                ':' + lostSeconds.value + `" />`;
            tr.appendChild(td1);
            tr.appendChild(td2);
            tr.appendChild(td3);
