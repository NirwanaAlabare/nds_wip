    ...
    <script>
        ...
        async function updateToNextProcessThree() {
            ...
            confirmButtonColor: "#6531a0",
                        ...
                        if (result.isConfirmed) {
                            let now = new Date();
                            startTime.value = now.getFullYear().toString() + "-" + pad(now.getMonth() + 1) + "-" + pad(now
                                .getDate()) + " " + pad(now.getHours()) + ":" + pad(now.getMinutes()) + ":" + pad(now
                                .getSeconds()); >>>
                            >>> > b07a696efb65285882a25b192141d4de8ef5fd1d
