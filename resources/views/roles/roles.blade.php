                    ...
                    render: (data, type, row, meta) => {
                        ...
                        return `
                            <div class='d-flex gap-1 justify-content-center'>
                                <a class='btn btn-primary btn-sm' data-bs-toggle="modal" data-bs-target="#editRoleModal" onclick='editData(` + JSON.stringify(row) + `, "editRoleModal", [{"function" : "dataTableUserReload(); dataTableUserRoleReload();"}]);' `+(disabled ? "disabled" : "")+`>
