...
<body>
    ...
    <div style=" padding: 5px; @if(!$loop->last) page-break-after: always; @endif">
        <div> PENERIMAAN GUDANG INPUTAN (ACCESORIES)</div><br>
        ...
        <table style="width: 100%;margin-bottom: 5px;">
            ...
            <tr>
                <td style="padding-left: 1px;font-size: 7px;">{{ $row->no_box }}</td>
                <td style="padding-left: 1px;font-size: 7px;">{{ $row->buyer }}</td>
                <td style="padding-left: 1px;font-size: 7px;">{{ $row->worksheet }}</td>
                <td style="padding-left: 1px;font-size: 7px;">{{ $row->nama_barang }}</td>
                <td style="padding-left: 1px;font-size: 7px;">{{ $row->kode }}</td>
                ...
                <td style="padding-left: 1px;font-size: 7px;">{{ $row->qty_kgm }}</td>
