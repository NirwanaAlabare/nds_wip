...
@section('content')
    <div class="d-flex justify-content-between mb-3">
        <h5 class="fw-bold text-sb"><i class="fa fa-plus fa-sm"></i> Tambah Pengeluaran Gudang Inputan (FG)</h5>
    ...
    <form action="{{ route('store-pengeluaran-gudang-inputan-fg') }}" method="post" id="store-pengeluaran-gudang-inputan-fg" onsubmit="submitForm(this, event)">
        @csrf
...
@section('custom-script')
    ...
    <script>
        ...
        $(document).on('click', '#btnSimpan', function() {
            ...
            $('#store-pengeluaran-gudang-inputan-fg').submit();
        });
