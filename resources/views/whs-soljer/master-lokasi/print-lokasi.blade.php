    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td style="vertical-align: middle; text-align: center;width:70%">
             ...
             <img style="width: 60%" src="data:image/png;base64, {!! base64_encode(QrCode::format('svg')->size(100)->generate('http://nag.ddns.net:8003/nds_wip/public/index.php/dashboard-rak/detail/'.$dataLokasi->kode)) !!}">
             <!-- {{$dataLokasi->id}} -->
            </td>
            <td style="width:15%"></td>
        </tr>
