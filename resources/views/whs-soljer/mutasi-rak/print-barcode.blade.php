...
<body>
    ...
    <div style=" padding: 5px; @if(!$loop->last) page-break-after: always; @endif">
        <div> MUTASI RAK (FABRIC)</div><br>
        <table style="width: 100%;margin-bottom: 5px;">
            <tr>
                <th style="border: none;vertical-align: middle; width: 70px;">No Mutasi</th>
                <td style="border: none;vertical-align: middle;padding: 2px; width: 10px;"> : </td>
                <th style="border: none;vertical-align: middle;">{{ $row->no_mutasi }}</th>
            </tr>
            <tr>
                <th style="border: none;vertical-align: middle;">Tgl Mutasi</th>
                <td style="border: none;vertical-align: middle;padding: 2px;"> : </td>
                <th style="border: none;vertical-align: middle;">{{ $row->tgl_mutasi }}</th>
            </tr>
            {{-- <tr>
        ...
        <table style="width: 100%;margin-bottom: 5px;">
            <tr>
                ...
                <th style="padding-left: 1px;font-size: 7px;">Lokasi Asal</th>
                <th style="padding-left: 1px;font-size: 7px;">Lokasi Tujuan</th>
            </tr>
            <tr>
                ...
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->lokasi_asal }}</td>
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->lokasi_tujuan }}</td>
            </tr>
        </table>
