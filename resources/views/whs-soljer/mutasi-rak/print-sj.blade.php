...
<body>
    <table width="100%" style="border:none;font-size: 9px;">
        ...
        <tr>
            ...
            <td width="240px" style="margin-right:-5px;border:none;" align="left">Bandung, {{  $dataHeader->tgl_mutasi }}</td>
        </tr>
        <tr>
    ...
    <table width="100%" style="border:none;">
        <tr style="line-height: 8px;">
            <td align="center" style="border:none;"><h3>Bukti Mutasi Rak (FABRIC)</h3></td>
        </tr>
        <tr style="line-height: 8px;">
            <td align="center" style="border:none; font-size:14pt;">{{ $dataHeader->no_mutasi }}</td>
        </tr>
    </table>
    <br>
    <table width="100%" style="border:none; font-size:9pt">
        <tr>
            <td width="70px;">No Mutasi</td>
            <td> : {{ $dataHeader->no_mutasi }}</td>
            <td width="100px;">Lokasi Tujuan</td>
            <td> : {{ $dataHeader->lokasi_tujuan }}</td>
        </tr>
        <tr>
            <td>Tgl Mutasi</td>
            <td> : {{ $dataHeader->tgl_mutasi }}</td>
            <td>Keterangan</td>
            <td> : {{ $dataHeader->keterangan }}</td>
        </tr>
    </table>
    ...
    <table class="main" repeat_header="1" border="1" cellspacing="0" width="100%" style="border-collapse: collapse; width:100%; font-size: 11px;">
        <thead>
            <tr class="head">
                ...
                <td align="center">Lokasi Asal</td>
                <td align="center">Lokasi Tujuan</td>
            </tr>
        </thead>
        <tbody>
        @php
        ...
        @foreach ($dataDetail as $row)
            ...
            <tr>
                ...
                <td align="left">{{ $row->lokasi_asal }}</td>
                <td align="left">{{ $row->lokasi_tujuan }}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
