...
@section('content')
    <div class="card card-sb">
        <div class="card-header">
            <h5 class="card-title fw-bold mb-0"> Laporan Penerimaan Per Kategori</h5>
        </div>
        <div class="card-body">
...
@section('custom-script')
    ...
    <script>
        ...
        let tableFabric = $("#datatable-fabric").DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: '{{ route('laporan-penerimaan-per-kategori') }}',
                data: function(d) {
        ...
        async function exportExcel() {
            ...
            await $.ajax({
                url: "{{ route("export-laporan-penerimaan-per-kategori") }}",
                type: "post",
                data: {
                    from : $("#tgl-awal").val(),
                    to : $("#tgl-akhir").val(),
                ...
                success: function (res) {
                    ...
                    link.download = "Laporan Penerimaan Per Kategori "+$("#tgl-awal").val()+" - "+$("#tgl-akhir").val()+".xlsx";
                    link.click();
                },
