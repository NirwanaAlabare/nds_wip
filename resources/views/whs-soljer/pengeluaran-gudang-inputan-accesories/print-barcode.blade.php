...
<body>
    ...
    <div style=" padding: 5px; @if(!$loop->last) page-break-after: always; @endif">
        <div> PENGELUARAN GUDANG INPUTAN (ACCESORIES)</div><br>
        ...
        <table style="width: 100%;margin-bottom: 5px;">
            <tr>
                <th style="padding-left: 1px;font-size: 7px;">No Box/Koli</th>
                <th style="padding-left: 1px;font-size: 7px;">Buyer</th>
                <th style="padding-left: 1px;font-size: 7px;">Worksheet</th>
                <th style="padding-left: 1px;font-size: 7px;">Nama Barang</th>
                <th style="padding-left: 1px;font-size: 7px;">Kode</th>
                ...
                <th style="padding-left: 1px;font-size: 7px;">Qty KGM</th>
                ...
                <th style="padding-left: 1px;font-size: 7px;">Qty KGM Out</th>
            </tr>
            <tr>
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->no_box }}</td>
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->buyer }}</td>
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->worksheet }}</td>
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->nama_barang }}</td>
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px;">{{ $row->kode }}</td>
                ...
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px; text-align: right;">{{ number_format($row->qty_kgm_act, 2) }}</td>
                ...
                <td style="padding-left: 1px; padding-right: 1px; font-size: 7px; text-align: right;">{{ number_format($row->qty_kgm_out, 2) }}</td>
            </tr>
        </table>
