    ...
    <script>
        ...
        let datatable = $("#datatable").DataTable({
            ...
            footerCallback: function(row, data, start, end, display) {
                ...
                // let total_awal  = api.column(9,  {page:'current'}).data().reduce((a, b) => intVal(a) + intVal(b), 0);
                // let total_in    = api.column(10, {page:'current'}).data().reduce((a, b) => intVal(a) + intVal(b), 0);
        ...
        function export_excel() {
            ...
            $.ajax({
                type: "get",
                url: '{{ route('export_excel_mut_detail') }}',
                data: {
                    from: from,
                    to: to
                },
                ...
                success: function(response) {
                    {
                        ...
                        link.download = "Laporan Mutasi Detail Dari  " + from + " sampai " +
                        to + ".xlsx";
                        link.click();
