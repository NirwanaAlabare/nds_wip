    ...
    <div class="card report-detail-card">
        <div class="card-header">
            <div>
                ...
                <h3 class="card-title mb-0">
                    Laporan Mutasi {{ strtoupper($kategoriBarang == 'sparepart' ? 'Sparepart' : 'Mesin & Peralatan Kantor') }}
        ...
        <div class="card-body">
            ...
            <div id="table-loader" class="text-center py-5">
                ...
                <h5 class="mt-3 text-muted font-weight-bold">Memproses Data Mutasi...</h5>
        ...
        $(document).ready(function() {
            setTimeout(function() {
                $('#tabel-report').DataTable({
                    ...
                    "language": { "emptyTable": "Tidak ada data mutasi untuk kategori ini pada periode tersebut." },
            ...
            //             let filename = "Laporan_Mutasi_{{ ucfirst($kategoriBarang) }}.xls";
            ...
            $('#btn-export-excel').on('click', function(e) {
                ...
                $.ajax({
                    type: "get",
                    url: '{{ route('export_excel_mutasi_mesin') }}',
                    data: {
                        from: $('#from').val(),
                        to: $('#to').val(),
                    ...
                    success: function(response) {
                        {
                            ...
                            link.download = "Laporan Mutasi Mesin dan Sparepart" + $('#from').val() + " sampai " +
                                $('#to').val() + ".xlsx";
                            link.click();
