...
@section('title', 'Laporan Mutasi Barang Jadi Gudang - ' . strtoupper($kategoriBarang == 'all' ? 'Semua Kategori' : $kategoriBarang))
...
@section('content')
    <div class="card report-detail-card mutasi-fg-gudang">
